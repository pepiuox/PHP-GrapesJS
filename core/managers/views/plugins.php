...
if ($w == "list") {
    ...
    <div class="container">
        <div class="row pt-3">
            <table class="table">
                <thead>
                    <tr>
                        <th><a id="addrow" name="addrow" title="Agregar" class="btn btn-primary" href="../plugins/add">Add <i class="fas fa-plus-square"></i></a></th>
                        <th>Id</th>
                        <th>Plugins</th>
                        <th>Plugins Opts</th>
                        <th>Script</th>
                ...
                <tbody>
                    ...
                    while ($mnop = $mopt->fetch_array()) {
                        ...
                        <tr>
                            <td><!--Button -->
                                <a id="editrow" name="editrow" title="Edit" class="btn btn-success" href="../plugins/edit&id=' . $mnop['id'] . '"><i class="fas fa-edit"></i></a>
                                <a id="deleterow" name="deleterow" title="Delete" class="btn btn-danger" href="../crud/delete&id=' . $mnop['id'] . '"><i class="fas fa-trash-alt"></i></a>
                            </td>
                            <td>' . $mnop['id'] . '</td>
                            <td>' . $mnop['plugins'] . '</td>
        ...
        <div class="row">
            <div class="col-md-3">
                <a class="btn btn-secondary"
                   href="../plugins/list">Back to List </a>
            </div>
            <div class="col-md-9">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <a href="../plugins/list">List Menu Option</a>
            </div>
            <div class="col-md-9">
                <center>
