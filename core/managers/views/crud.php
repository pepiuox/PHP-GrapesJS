...
if ($w == "select") {
    ...
    <div class="container">
        <div class="row pt-3">
            <div class="col-md-3">
                ...
                <a class="btn btn-success" href="dashboard/table_builder/editor&tbl=<?php echo $tble; ?>">Edit query Table </a>
            </div>
            <div class="col-md-9">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <a class="btn btn-secondary" href="dashboard/table_crud/list&tbl=<?php echo $tble; ?>">Back to List </a>
            </div>
            <div class="col-md-9">
