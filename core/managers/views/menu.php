...
if (isset($w) && !empty($w)) {
    ...
    <div class="container">
        <div class="row pt-3">
            <table class="table">
                <thead>
                    <tr>
                        <th><a id="addrow" name="addrow" title="Add" class="btn btn-primary" href="<?php echo SITE_PATH; ?>admin/dashboard/menu/add">Add <i class="fa fa-plus-square"></i></a></th><th>Id</th><th>Id menu</th><th>Fluid</th><th>Placement</th><th>Aligment</th><th>Background</th><th>Color</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    while ($mnop = $mopt->fetch_array()) {
                     ...
                     <tr>
                        <td><!--Button -->
                            <a id="editrow" name="editrow" title="Edit" class="btn btn-success" href="'.SITE_PATH.'admin/dashboard/menu/edit/' . $mnop['id'] . '"><i class="fas fa-edit"></i></a>
                            <a id="deleterow" name="deleterow" title="Delete" class="btn btn-danger" href="'.SITE_PATH.'admin/dashboard/menu/delete/' . $mnop['id'] . '"><i class="fas fa-trash-alt"></i></a>
                        </td>
                        <td>' . $mnop['id'] . '</td>
                        <td>' . $mnop['id_menu'] . '</td>
                        <td>' . $mnop['fluid'] . '</td>
        ...
        <div class="row">
            <div class="col-md-3">
                <a class="btn btn-secondary"
                   href="<?php echo SITE_PATH; ?>admin/dashboard/menu/list">Back to List </a>
            </div>
            <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="row pt-3">
                            <form role="form" id="edit_menu_options" method="POST">
                                ...
                                <?php
                                enumsel('menu_options', 'fluid', $mopt['fluid']);
                                enumsel('menu_options', 'placement', $mopt['placement']);
                                enumsel('menu_options', 'aligment', $mopt['aligment']);
                                enumsel('menu_options', 'background', $mopt['background']);
                                enumsel('menu_options', 'color', $mopt['color']);
                                ?>                        
                                <div class="form-group">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <a href="<?php echo SITE_PATH; ?>admin/dashboard/menu/list">List Menu Option</a>
            </div>
            <div class="col-md-9">
                <center>
