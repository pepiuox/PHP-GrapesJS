            ...
            if (file_exists($targetDir) === false) {
                ...
                foreach ($dir_contents as $file) {
                    ...
                    if (in_array($file_type, $file_display) === true) {
                        $ImagesArray[] = "'" . SITE_PATH. 'build/uploads/' . $file . "'";
                    }
                }
                return $ImagesArray;
            }
...
';
        ...
        ?>
                ...
                <a href="<?php echo SITE_PATH; ?>" class="navbar-brand">
        <?php
        $logo = SITE_BRAND_IMG;
        if (file_exists($logo)) {
        ?>
        ...
        ?>
                ...
                assetManager: {
                    upload: '<?php echo SITE_PATH; ?>build/uploads', //for temporary storage
                    uploadName: 'files',
                    multiUpload: true,
                    assets: images,
                    uploadFile: function(e) {
                        ...
                        $.ajax({
                            type: 'post',
                            url: '<?php echo SITE_PATH; ?>core/managers/upImage.php',                
                            data: formData,
                            contentType: false,
                            crossDomain: true,
                            dataType: 'json',
                ...
                pn.addButton('options', {
                    id: 'open-templates',
                    className: 'fa fa-solid fa-folder',
                    attributes: {
                    title: 'Open projects and templates'
                    },
                    command: 'open-templates' //Open modal 
