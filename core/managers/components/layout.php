        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-8 text-center">
            ...
            <p class="mt-5 mt-sm-4">
              <a class="btn btn-primary" href="https://pepiuox.net">Download</a>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-6 text-center">
            ...
            <p class="mt-5 mt-sm-4">
              <a class="btn btn-secondary" href="https://pepiuox.net">Download</a>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-sm-8 col-md-6 col-lg-6 text-center">
            ...
            <p class="mt-5 mt-sm-4">
              <a class="btn btn-outline-primary" href="https://pepiuox.net">Download</a>
            </p>
          </div>
        </div>
      </div>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <section class="py-5">
      <div class="container">
        ...
        <div class="row">
          <div class="col-12 text-center">
            <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="<?php echo SITE_PATH; ?>assets/images/customers/adobe.svg">
            <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="<?php echo SITE_PATH; ?>assets/images/customers/amazon.svg">
            <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="<?php echo SITE_PATH; ?>assets/images/customers/ebay.svg">
            <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="<?php echo SITE_PATH; ?>assets/images/customers/samsung.svg">
            <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="<?php echo SITE_PATH; ?>assets/images/customers/orange.svg">
            <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="<?php echo SITE_PATH; ?>assets/images/customers/salesforce.svg">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-sm-10 col-md-8 col-lg-4 text-center">
            ...
            <p class="h2">
              <a href="https://pepiuox.net" class="mx-2"><i class="fab fa-facebook"></i></a>
              <a href="https://pepiuox.net" class="mx-2"><i class="fab fa-twitter"></i></a>
              <a href="https://pepiuox.net" class="mx-2"><i class="fab fa-instagram"></i></a>
              <a href="https://pepiuox.net" class="mx-2"><i class="fab fa-google"></i></a>
              <a href="https://pepiuox.net" class="mx-2"><i class="fab fa-pinterest"></i></a>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row text-center pt-4 pt-md-5">
          <div class="col-12 col-sm-10 col-md-6 col-lg-4 m-sm-auto">
            ...
            <p class="mt-3"><a class="btn btn-light sl-1" href="https://pepiuox.net">Button</a></p>
          </div>
    ...
    <section class="py-5">
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-auto">
            <h2>Use PePiuoX Design Blocks for free in your project</h2>
          </div>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-auto text-center">
            <a class="btn btn-outline-secondary" href="https://pepiuox.net">Download</a>
          </div>
      ...
      <div class="container">
        ...
        <div class="row align-items-center pt-2 pt-lg-5">
          <div class="col-12 col-md-8 col-lg-7">
            ...
            <p class="mt-4"><a class="btn btn-primary" href="https://pepiuox.net">Take a Tour</a></p>
          </div>
    
          <div class="col-8 col-md-4 m-auto m-md-0 ml-md-auto pt-5">
            <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/draws/git.svg">
          </div>
        </div>
      </div>
    </section>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <section class="py-5 fdb-viewport bg-dark" style="background-image: url(imgs/hero/purple.svg);">
      <div class="container justify-content-center align-items-center d-flex">
        <div class="row justify-content-center text-center">
          <div class="col-12 col-md-8">
            <img alt="image" class="fdb-icon" src="<?php echo SITE_PATH; ?>assets/images/icons/coffee.svg">
            <h1>PePiuoX Design Blocks</h1>
            <p class="lead">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
            <p class="mt-5"><a href="https://pepiuox.net" class="btn btn-dark">Call to Action</a></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-10 col-sm-6 col-md-4 col-lg-3 m-auto m-md-0">
            <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/draws/smile.svg">
          </div>
          ...
          <div class="col-12 col-md-8 ml-auto pt-5 pt-md-0">
            ...
            <p class="mt-4"><a class="btn btn-secondary" href="https://pepiuox.net">Take a Tour</a></p>
          </div>
        </div>
      </div>
    </section>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <section class="py-5 bg-dark fdb-viewport" style="background-image: url(imgs/hero/blue.svg);">
      <div class="container align-items-center justify-content-center d-flex">
        <div class="row justify-content-center text-center">
          <div class="col-12 col-md-10 col-lg-8">
            <h1>PePiuoX Design Blocks is Open Source and free to use in your apps</h1>
            <p class="mt-5"><a href="https://pepiuox.net" class="btn btn-outline-light">Call to Action</a></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center align-items-center pt-5">
          <div class="col-8 col-sm-3">
            <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/draws/code.svg">
          </div>
          ...
          <div class="col-12 col-sm-3 text-center pt-4 pt-sm-0">
            <p><a class="btn btn-outline-primary" href="https://pepiuox.net">Take a Tour</a></p>
            <p><a class="btn btn-primary" href="https://pepiuox.net">Start Now</a></p>
      ...
      <div class="container align-items-end justify-content-center d-flex">
        <div class="row align-items-top text-left">
          <div class="col-12 col-md-6 col-lg-5">
            <p class="mb-5 mt-5"><img alt="image" height="40" src="<?php echo SITE_PATH; ?>assets/images/logo.png"></p>
            <h1>Design Blocks</h1>
            <p class="lead">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
            <p class="mt-4"><a href="https://pepiuox.net" class="btn btn-primary">Call to Action</a></p>
          </div>
    
          <div class="col-12 col-sm-4 col-md-6 col-lg-4 m-auto pt-5">
            <img alt="image" class="img-fluid rounded-0" src="<?php echo SITE_PATH; ?>assets/images/draws/sync.svg">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container align-items-center justify-content-center d-flex">
        <div class="row align-items-center text-left">
          <div class="col-12 col-sm-6">
            <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/draws/sync2.svg">
          </div>
    
          <div class="col-12 col-lg-5 ml-auto pt-5 pt-lg-0">
            <h1>PePiuoX Design Blocks</h1>
            <p class="lead">Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p>
            <p class="mt-4"><a href="https://pepiuox.net" class="btn btn-secondary">Call to Action</a></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row align-items-center text-left">
          ...
          <div class="col-12 col-md-3 ml-auto text-left text-md-right">
            <p><a href="https://pepiuox.net" class="btn btn-primary">Call to Action</a></p>
          </div>
        </div>
    
        <div class="row pt-5">
          <div class="col-6 offset-3">
            <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/draws/rocket.svg">
          </div>
        </div>
      </div>
    </section>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <section class="py-5 fdb-viewport bg-dark" style="background-image: url(imgs/hero/red.svg);">
      <div class="container align-items-center justify-content-center d-flex">
        <div class="row align-items-center text-left">
          <div class="col-12 col-sm-10 col-md-8 col-lg-8">
            <h1>PePiuoX Design Blocks is build on Boostrap Framework</h1>
            <p class="lead">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there.</p>
            <p class="mt-5">
              <a href="https://pepiuox.net" class="btn btn-light">Call to Action</a>
              <a href="https://pepiuox.net" class="btn btn-dark ml-4">Button</a>
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="py-5">
      <div class="container">
        ...
        <div class="row text-center justify-content-center pt-5">
          ...
          <div class="col-12 col-sm-6 col-lg-3 pt-4 pt-lg-0">
            <img alt="image" class="fdb-icon" src="<?php echo SITE_PATH; ?>assets/images/icons/compass.svg">
      ...
      <div class="container">
        <div class="row mt-5">
          <div class="col-12 col-md-6 col-lg-5">
            ...
            <p class="h3 mt-5">
              <strong>Email:</strong> <a href="https://pepiuox.net">hello@website.com</a>
            </p>
            <p class="lead">
              <strong>Phone:</strong> <a href="https://pepiuox.net">+44 123 123 1232</a>
            </p>
          </div>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <section class="py-5 bg-dark" style="background-image: url(imgs/hero/blue.svg);">
      <div class="container">
        ...
        <div class="container">
          ...
          <div class="row justify-content-center text-center">
            <div class="col-12 col-md mr-auto ml-auto">
              <img alt="image" height="40" class="mb-2" src="<?php echo SITE_PATH; ?>assets/images/icons/phone.svg">
              <p class="lead">+44 (112) 123 752</p>
            </div>
    
            <div class="col-12 col-md pt-4 pt-md-0 mr-auto ml-auto">
              <img alt="image" height="40" class="mb-2" src="<?php echo SITE_PATH; ?>assets/images/icons/navigation.svg">
              <p class="lead">123 6th St.<br>Melbourne, FL 32904</p>
            </div>
    
            <div class="col-12 col-md pt-4 pt-md-0 mr-auto ml-auto">
              <img alt="image" height="40" class="mb-2" src="<?php echo SITE_PATH; ?>assets/images/icons/mail.svg">
    ...
    <section class="py-5 py-0">
      <div class="container py-5" style="background-image: url(imgs/shapes/6.svg);">
        <div class="row text-center justify-content-center">
          <div class="col-12 col-md-8 col-lg-7">
            <h1>Contact Us</h1>
            <p class="lead">If you’re already an active user, please <a href="https://pepiuox.net">sign in</a> before contacting us.</p>
          </div>
        </div>
        <div class="row-50">
        </div>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <section class="py-5 pt-0" style="background-image: url(<?php echo SITE_PATH; ?>assets/images/shapes/8.svg)">
      <div class="bg-gray">
        <div class="container">
          <div class="row-100"></div>
      ...
      <div class="container bg-r">
        ...
        <div class="row">
          <div class="col-12 col-md-6 col-lg-5">
            ...
            <p>
              <a href="https://pepiuox.net">Contact Support</a>
            </p>
            <p>
            ...
            <p>
              <a href="https://pepiuox.net">Contact Sales</a>
            </p>
            <p>
              Our technical support is available by phone or email from 11am to 11pm BST, Monday through Friday.
            </p>
            ...
            <p>
              <a href="https://pepiuox.net">hello@website.com</a>
            </p>
          </div>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    ...
    ,    <section class="py-5">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col col-md-8 text-center">
            <p class="lead">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in <a href="https://pepiuox.net">Bookmarksgrove</a> right at the coast of the Semantics, a large language
              ocean.</p>
          </div>
        </div>
      </div>
    ...
    <section class="py-5">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col col-md-8 text-center">
            <h1>PePiuoX Design Blocks</h1>
            <p class="lead">Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far <a href="https://pepiuox.net">World of Grammar</a>.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col text-left">
            ...
            <p>Far far away, behind the word mountains, far from the countries <a href="https://pepiuox.net">Vokalia</a> and <a href="https://pepiuox.net">Consonantia</a>, there live the blind texts. Separated they live in Bookmarksgrove right at the coast
      ...
      <div class="container">
        <div class="row">
          <div class="col text-center">
            ...
            <p class="lead">
              <a href="https://pepiuox.net" class="mx-2">Learn More <i class="fas fa-angle-right"></i></a>
              <a href="https://pepiuox.net" class="mx-2">Buy <i class="fas fa-angle-right"></i></a>
            </p>
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="col-6">
            <img alt="image" class="img-fluid mt-5" src="<?php echo SITE_PATH; ?>assets/images/draws/hosting.svg">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="row pt-5 justify-content-center align-items-center">
          <div class="col-6 col-md-2">
            <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/shapes/1.svg">
          </div>
          <div class="col-6 col-md-2 offset-md-1">
            <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/shapes/5.svg">
          </div>
          <div class="col-6 col-md-2 mt-4 mt-md-0 offset-md-1">
            <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/shapes/7.svg">
          </div>
          <div class="col-6 col-md-2 mt-4 mt-md-0 offset-md-1">
            <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/shapes/4.svg">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-12 col-md-6 ml-md-auto mt-4 mt-md-0">
            <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/shapes/2.svg">
          </div>
        </div>
      </div>
    </section>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <section class="py-5">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col col-md-8 text-center">
            <img alt="image" class="fdb-icon mb-4" src="<?php echo SITE_PATH; ?>assets/images/icons/gift.svg">
            <p class="lead">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-12 col-md-6 col-lg-5 ml-md-auto text-left">
            ...
            <p><a class="btn btn-secondary mt-4" href="https://pepiuox.net">Download</a></p>
          </div>
        </div>
      </div>
    </section>
    ,    <section class="py-5" style="background-image: url(<?php echo SITE_PATH; ?>assets/images/shapes/8.svg)">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-6 col-lg-5">
            <img alt="image" class="fdb-icon" src="<?php echo SITE_PATH; ?>assets/images/icons/github.svg">
          ...
          <div class="col-10 col-sm-6 m-auto col-md-4 pt-4 pt-md-0">
            <img alt="image" class="img-fluid rounded-0" src="<?php echo SITE_PATH; ?>assets/images/draws/chat.svg">
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-8 text-center">
            <div class="row justify-content-center pb-5">
              <div class="col-4 col-sm-3 col-md-2"><img alt="image" class="fdb-icon" src="<?php echo SITE_PATH; ?>assets/images/icons/layers.svg"></div>
              <div class="col-4 col-sm-3 col-md-2"><img alt="image" class="fdb-icon" src="<?php echo SITE_PATH; ?>assets/images/icons/map.svg"></div>
              <div class="col-4 col-sm-3 col-md-2"><img alt="image" class="fdb-icon" src="<?php echo SITE_PATH; ?>assets/images/icons/monitor.svg"></div>
            </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-10 col-sm-6 m-auto col-md-4 pb-4 pb-md-0">
            <img alt="image" class="img-fluid rounded-0" src="<?php echo SITE_PATH; ?>assets/images/draws/chatting.svg">
          </div>
    
          <div class="col-12 ml-auto col-md-6 col-lg-5">
            <h1>Design Blocks</h1>
            <p class="lead">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
            <p><a class="btn btn-primary mt-4 mb-5 mb-md-0" href="https://pepiuox.net">Download</a></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-12 col-md-8 m-auto ml-lg-auto mr-lg-0 col-lg-6 pt-5 pt-lg-0">
            <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/draws/browsers.svg">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row text-left">
          ...
          <div class="col-12 col-md-6 pt-5 pt-md-0">
            ...
            <p class="lead">Separated they live in Bookmarksgrove right at the coast of the Semantics, far far away, behind the word mountains, far from the countries <a href="https://pepiuox.net">Vokalia and Consonantia</a>, there live the blind texts. </p>
          </div>
        </div>
      </div>
    </section>
            ...
            <div class="fdb-box">
              <div class="row justify-content-center">
                <div class="col-12 col-xl-8 text-center">
                  ...
                  <p class="h3 mt-4"><a href="https://pepiuox.net">Learn More <i class="fas fa-angle-right"></i></a></p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="fdb-box fdb-touch">
              <div class="row justify-content-center">
                <div class="col-12 col-xl-8 text-center">
                  ...
                  <p class="h3 mt-4"><a href="https://pepiuox.net" class="btn btn-primary">Register</a></p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-lg-8 col-xl-6 text-center">
            <img alt="image" width="200" src="<?php echo SITE_PATH; ?>assets/images/logo.png">
            <h1>PePiuoX Design Blocks</h1>
            ...
            <p class="h3 mt-5"><a href="https://pepiuox.net" class="btn btn-primary">Download Now</a></p>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-10 col-sm-6 col-md-5 col-lg-4 m-auto pb-5 pb-md-0">
            <img alt="image" class="img-fluid rounded-0" src="<?php echo SITE_PATH; ?>assets/images/draws/iphone-hand.svg">
          </div>
          ...
          <div class="col-12 ml-md-auto col-md-7 col-lg-6 pb-5 pb-md-0">
            ...
            <p class="mt-4">
              <a class="btn btn-secondary" href="https://pepiuox.net">Download</a>
              <a class="btn btn-dark ml-3" href="https://pepiuox.net">Register</a>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-7 col-lg-5 ml-md-auto">
            ...
            <p class="mt-5">
              <img alt="image" height="25" class="mr-4" src="<?php echo SITE_PATH; ?>assets/images/customers/samsung.svg">
              <img alt="image" height="25" class="mr-4" src="<?php echo SITE_PATH; ?>assets/images/customers/adobe.svg">
              <img alt="image" height="25" src="<?php echo SITE_PATH; ?>assets/images/customers/amazon.svg">
            </p>
          </div>
    
          <div class="col-10 col-sm-6 col-md-5 col-lg-4 m-auto pt-5 pt-md-0">
            <img alt="image" class="img-fluid rounded-0" src="<?php echo SITE_PATH; ?>assets/images/draws/customer-survey.svg">
          </div>
        </div>
      </div>
    </section>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <section class="py-5">
      <div class="container">
          ...
          <div class="col-12">
            <div class="row justify-content-center pb-5">
              <div class="col-12 col-lg-8 text-center">
                <h1>PePiuoX Design Blocks is Open Source and free to use</h1>
              </div>
            </div>
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="col-8">
            <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/draws/android.svg">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container py-5">
        <div class="row">
          <div class="col-12 col-md-5 text-center">
            <h1>PePiuoX Blocks</h1>
            <p class="lead">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
            <p class="mt-4 mb-5"><a class="btn btn-secondary" href="https://pepiuox.net">Button</a></p>
    
            <p>Follow us on</p>
            <p>
              <a href="https://pepiuox.net" class="mx-2 text-secondary"><i class="fab fa-twitter" aria-hidden="true"></i></a>
              <a href="https://pepiuox.net" class="mx-2 text-secondary"><i class="fab fa-facebook" aria-hidden="true"></i></a>
              <a href="https://pepiuox.net" class="mx-2 text-secondary"><i class="fab fa-instagram" aria-hidden="true"></i></a>
              <a href="https://pepiuox.net" class="mx-2 text-secondary"><i class="fab fa-pinterest" aria-hidden="true"></i></a>
              <a href="https://pepiuox.net" class="mx-2 text-secondary"><i class="fab fa-google" aria-hidden="true"></i></a>
            </p>
          </div>
        </div>
      </div>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <section class="py-5 bg-dark">
      <div class="container">
        <div class="row text-center">
          <div class="col-12">
            <h1>Made with <i class="fas fa-heart text-danger"></i> by PePiuoX</h1>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row text-center align-items-center">
          <div class="col-8 col-md-4">
            <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/photos/map-1.jpg">
          </div>
    
          <div class="col-4 col-md-2">
            <div class="row">
              <div class="col-12">
                <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/photos/map-2.jpg">
              </div>
            </div>
    
            <div class="row mt-4">
              <div class="col-12">
                <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/photos/map-3.jpg">
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-6 col-lg-3">
            <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/photos/fireworks-1.jpg">
          </div>
    
          <div class="col-6 col-lg-3">
            <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/photos/fireworks-2.jpg">
          </div>
          ...
          <div class="col-12 col-lg-6 pt-3">
            ...
            <p class="lead text-left">Right at the coast of the Semantics, a large language ocean. A small river named Duden. <a href="https://pepiuox.net">[Read More]</a></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row text-left align-items-center">
          <div class="col-12 col-md-6 col-lg-4">
            <h2>Your Website</h2>
            <p class="lead">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
            <p class="lead"><a href="https://pepiuox.net">Read More</a></p>
          </div>
          ...
          <div class="col-12 col-md-8 m-auto m-lg-0 col-lg-4 pt-5 pt-lg-0">
            <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/draws/tabs.svg">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="row text-center pt-3 pt-xl-5">
          <div class="col-12 col-sm-10 m-auto m-md-0 col-md-6">
            <img alt="image" height="300" src="<?php echo SITE_PATH; ?>assets/images/draws/tenis.svg">
          ...
          <div class="col-12 col-sm-10 m-auto m-md-0 col-md-6 pt-5 pt-md-0">
            <img alt="image" height="300" src="<?php echo SITE_PATH; ?>assets/images/draws/basketball.svg">
        ...
        <div class="row text-left pt-5">
          <div class="col-12 col-md-8 col-lg-6">
            <div class="fdb-box fdb-touch rounded-bottom-0">
              ...
              <p class="lead mt-4"><a href="https://pepiuox.net">Read More</a></p>
            </div>
          </div>
        </div>
      </div>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <section class="py-5 pb-0" style="background-image: url(imgs/hero/purple.svg);">
      <div class="container">
        <div class="row text-left justify-content-end">
          <div class="col-12 col-md-6 col-xl-5">
            <div class="fdb-box rounded-bottom-0">
              ...
              <p class="lead mt-4"><a class="btn btn-outline-primary" href="https://pepiuox.net">Read More</a></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row text-left align-items-center">
          <div class="col-10 col-sm-6 m-auto m-lg-0 col-lg-4">
            <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/draws/opened.svg">
          </div>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)"><footer class="py-5 footer-large bg-dark">
      <div class="container">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-8 col-lg-6 text-center">
            ...
            <p class="h4">Find us on <a href="https://pepiuox.net">Facebook</a> and <a href="https://pepiuox.net">Twitter</a>.</p>
          </div>
        </div>
      </div>
    </section>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <section class="py-5" style="background-image: url(imgs/hero/blue.svg);">
      <div class="container">
        <div class="fdb-box">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)"><section class="py-5">
      <div class="container">
        <div class="row justify-content-center">
              ...
              <div class="col">
                <div class="form-check">
                  <label class="form-check-label">
                      ...
                      I Read and Accept <a href="https://pepiuox.net">Terms and Conditions</a>
                    </label>
                </div>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <section class="py-5" style="background-image: url(imgs/hero/red.svg);">
      <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="fdb-box">
              ...
              <div class="row mt-4">
                <div class="col">
                  ...
                  <p class="text-right"><a href="https://pepiuox.net">Recover Password</a></p>
                </div>
              </div>
              <div class="row mt-4">
                <div class="col">
          ...
          <div class="col-12 col-md-8 col-lg-7 col-md-5 text-center">
            <div class="fdb-box fdb-touch">
              ...
              <div class="row mt-4">
                <div class="col">
                  <input type="password" class="form-control mb-1" placeholder="Password">
                  <p class="text-right"><a href="https://pepiuox.net">Already have an account?</a></p>
                </div>
              </div>
              <div class="row mt-4">
                <div class="col">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12  col-md-10 col-lg-8 col-xl-6 text-center">
            <img alt="image" height="40" src="<?php echo SITE_PATH; ?>assets/images/icons/layers.svg">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-6 m-md-auto ml-lg-0 col-lg-5">
            <img alt="image" class="img-fluid" src="<?php echo SITE_PATH; ?>assets/images/draws/group-chat.svg">
          </div>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
       <section class="py-5" style="background-image: url(imgs/shapes/1.svg);">
      <div class="container">
        <div class="row justify-content-end">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <header>
      <div class="container">
        <nav class="navbar">
          <a href="https://pepiuox.net">
            <img src="<?php echo SITE_PATH; ?>assets/images/logo.png" height="30" alt="image">
          </a>
        </nav>
      </div>
    </header>
    ,    <header>
      <div class="container text-center">
        <nav class="navbar">
          <a class="ml-auto mr-auto" href="https://pepiuox.net">
            <img src="<?php echo SITE_PATH; ?>assets/images/logo.png" height="30" alt="image">
          </a>
        </nav>
      </div>
          ...
          <div class="collapse navbar-collapse" id="navbarNav0">
            <ul class="navbar-nav mr-auto ml-auto">
              <li class="nav-item active">
                <a class="nav-link" href="https://pepiuox.net">Home <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://pepiuox.net">Features</a>
              </li>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <header>
      <div class="container">
        <nav class="navbar navbar-expand-md">
          <a class="navbar-brand" href="https://pepiuox.net">
            <img src="<?php echo SITE_PATH; ?>assets/images/logo.png" height="30" alt="image">
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav1">
            ...
            <ul class="navbar-nav justify-content-end d-none d-lg-flex ml-md-auto">
              <li class="nav-item">
                <a class="nav-link" href="https://pepiuox.net"><i class="fab fa-slack"></i></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://pepiuox.net"><i class="fab fa-twitter"></i></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://pepiuox.net"><i class="fab fa-github"></i></a>
              </li>
            </ul>
    
            <a class="btn btn-outline-primary ml-md-3" href="https://pepiuox.net">Button</a>
          </div>
        </nav>
      </div>
    </header>
      ...
      <div class="container">
        <nav class="navbar navbar-expand-md no-gutters">
          ...
          <ul class="navbar-nav col-2 justify-content-end d-none d-md-flex">
            <li class="nav-item">
              <a class="nav-link" href="https://pepiuox.net"><i class="fab fa-facebook"></i></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="https://pepiuox.net"><i class="fab fa-twitter"></i></a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="https://pepiuox.net"><i class="fab fa-google"></i></a>
            </li>
          </ul>
        </nav>
      </div>
        ...
        <nav class="navbar navbar-expand-lg">
          ...
          <div class="collapse navbar-collapse" id="navbarNav5">
            ...
            <ul class="navbar-nav justify-content-end ml-auto">
              <li class="nav-item">
                <a class="nav-link" href="https://pepiuox.net">Docs</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://pepiuox.net">Contact</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://pepiuox.net">Log In</a>
              </li>
            </ul>
    
            <a class="btn btn-primary ml-md-3" href="https://pepiuox.net">Button</a>
          </div>
        </nav>
      </div>
    </header>
      ...
      <div class="container">
        <nav class="navbar navbar-expand-md no-gutters">
          ...
          <div class="collapse navbar-collapse justify-content-end col-md-2 navbar-collapse-1">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link" href="https://pepiuox.net">Log In <i class="fas fa-sign-in-alt"></i></a>
              </li>
            </ul>
          </div>
        </nav>
      ...
      <div class="container">
        <nav class="navbar navbar-expand-md no-gutters">
          ...
          <div class="collapse navbar-collapse navbar-collapse-2">
            ...
            <a class="btn btn-primary ml-md-3" href="https://pepiuox.net">Register</a>
          </div>
        </nav>
      </div>
    </header>
      ...
      <div class="container">
        <nav class="navbar navbar-expand-md">
          ...
          <div class="collapse navbar-collapse" id="navbarNav9">
            ...
            <a class="btn btn-outline-light ml-md-3" href="https://pepiuox.net">Button</a>
          </div>
        </nav>
      </div>
    </header>
      ...
      <div class="container">
        <nav class="navbar navbar-expand-lg">
          ...
          <div class="collapse navbar-collapse" id="navbarNav13">
            ...
            <a class="btn btn-light ml-md-3" href="https://pepiuox.net">Button</a>
          </div>
        </nav>
      </div>
    </header>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <section class="py-5" style="background-image: url(<?php echo SITE_PATH; ?>assets/images/shapes/1.svg)">
      <div class="container">
        <div class="row text-center">
          <div class="col">
        ...
        <div class="row mt-5 align-items-center">
          <div class="col-12 col-sm-10 col-md-8 col-md-8 m-auto col-lg-4 text-center">
            <div class="fdb-box shadow pb-5 pt-5 pl-3 pr-3 rounded">
              ...
              <p><a href="https://pepiuox.net" class="btn btn-outline-primary mt-4">Subscribe</a></p>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-10 col-md-8 col-md-8 m-auto col-lg-4 text-center pt-4 pt-lg-0">
            <div class="fdb-box shadow pb-5 pt-5 pl-3 pr-3 fdb-touch rounded">
              ...
              <p><a href="https://pepiuox.net" class="btn btn-primary mt-4">Subscribe</a></p>
            </div>
          </div>
        ...
        <div class="row mt-5 align-items-center">
          <div class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-left">
            <div class="fdb-box fdb-touch p-5 rounded">
              ...
              <p class="text-left pt-4"><a href="https://pepiuox.net" class="btn btn-primary">Buy Now</a></p>
            </div>
          </div>
        ...
        <div class="row mt-5 align-items-center">
          <div class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-center">
            <div class="fdb-box p-4">
              ...
              <p><a href="https://pepiuox.net" class="btn btn-dark">Buy Now</a></p>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-center pt-4 pt-lg-0">
            <div class="fdb-box px-4 pt-5">
              ...
              <p><a href="https://pepiuox.net" class="btn btn-secondary">Buy Now</a></p>
            </div>
          </div>
        ...
        <div class="row py-5 align-items-top">
          <div class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-left">
            <div class="bg-gray pb-5 pt-5 pl-4 pr-4 rounded shadow">
              ...
              <p><br></p>
              <p><br></p>
              <p class="text-center pt-4"><a href="https://pepiuox.net" class="btn btn-primary">Choose Plan</a></p>
            </div>
          </div>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <section class="py-5" style="background-image: url(imgs/shapes/8.svg);">
      <div class="container">
        <div class="row text-center">
          <div class="col">
            <h1>Pricing Plans</h1>
        ...
        <div class="row mt-5 align-items-center no-gutters">
          <div class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-center shadow">
            <div class="bg-white pb-5 pt-5 pl-4 pr-4 rounded-left">
              ...
              <p class="text-center pt-4"><a href="https://pepiuox.net" class="btn btn-outline-dark">Choose Plan</a></p>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-10 col-md-8 ml-auto mr-auto col-lg-4 text-center mt-4 mt-lg-0 sl-1 pt-0 pt-lg-3 pb-0 pb-lg-3 bg-white fdb-touch rounded shadow">
            <div class="pb-5 pt-5 pl-4 pr-4">
              ...
              <p class="text-center pt-4"><a href="https://pepiuox.net" class="btn btn-primary btn-shadow">Choose Plan</a></p>
            </div>
          </div>
        ...
        <div class="row mt-5 align-items-top">
          <div class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-left">
            <div class="rounded">
              ...
              <div class="bg-gray p-5 text-center">
                <p><img alt="image" height="40" src="<?php echo SITE_PATH; ?>assets/images/icons/layers.svg"></p>
                ...
                <p class="text-center pt-5"><a href="https://pepiuox.net" class="btn btn-secondary">Choose Plan</a></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-left pt-4 pt-lg-0">
            <div class="rounded">
              ...
              <div class="bg-gray p-5 text-center">
                <p><img alt="image" height="40" src="<?php echo SITE_PATH; ?>assets/images/icons/monitor.svg"></p>
          ...
          <div class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-left pt-4 pt-lg-0">
            <div class="rounded">
              ...
              <div class="bg-gray p-5 text-center">
                <p><img alt="image" height="40" src="<?php echo SITE_PATH; ?>assets/images/icons/package.svg"></p>
        ...
        <div class="row mt-5 align-items-top">
          <div class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-center">
            <div class="bg-gray pb-5 pt-5 pl-4 pr-4 rounded">
              ...
              <p class="text-center pt-5"><a href="https://pepiuox.net" class="btn btn-primary">Subscribe</a></p>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row mt-5 align-items-top">
          <div class="col-12 col-md-8 m-auto col-lg-4 text-center">
            <img alt="image" height="60" src="<?php echo SITE_PATH; ?>assets/images/icons/cloud.svg">
            ...
            <p class="text-center mt-4 mt-lg-5"><a href="https://pepiuox.net" class="btn btn-primary">Choose Plan</a></p>
          </div>
    
          <div class="col-12 col-md-8 col-lg-4 text-center m-auto pt-5 pt-lg-0">
            <img alt="image" height="60" src="<?php echo SITE_PATH; ?>assets/images/icons/life-buoy.svg">
          ...
          <div class="col-12 col-md-8 m-auto col-lg-4 text-center pt-5 pt-lg-0">
            <img alt="image" height="60" src="<?php echo SITE_PATH; ?>assets/images/icons/layers.svg">
        ...
        <div class="row mt-5 align-items-top">
          <div class="col-12 col-sm-10 col-md-6 col-lg-5 m-auto col-xl-3 text-left">
            <div class="bg-gray p-3 text-center rounded sl-1">
              <h2 class="font-weight-light">Startup</h2>
              <p class="h2">$99</p>
              <p class="text-center"><a href="https://pepiuox.net" class="btn btn-outline-secondary">Buy Now</a></p>
          ...
          <div class="col-12 col-sm-10 col-md-6 col-lg-5 m-auto col-xl-3 text-left pt-5 pt-md-0">
            <div class="bg-gray p-3 text-center rounded sl-1">
              ...
              <p class="h2">$399</p>
              <p class="text-center"><a href="https://pepiuox.net" class="btn btn-secondary">Buy Now</a></p>
          ...
          <div class="col-12 col-sm-10 col-md-6 col-lg-5 m-auto col-xl-3 text-left pt-5 pt-xl-0">
            <div class="bg-gray p-3 text-center rounded sl-1">
              ...
              <p class="text-center"><a href="https://pepiuox.net" class="btn btn-outline-secondary">Contact</a></p>
          ...
          <tbody>
            <tr>
              ...
              <td class="text-center border-0">
                ...
                <p class="lead">$99</p>
                <p><a href="https://pepiuox.net" class="btn btn-outline-primary">Buy Now</a></p>
              </td>
              <td class="text-center border-0">
                <h2 class="font-weight-light">Professional</h2>
                <p class="lead">$399</p>
              ...
              <td class="text-center border-0">
                <h2 class="font-weight-light">Business</h2>
                <p class="lead">$899</p>
                <p><a href="https://pepiuox.net" class="btn btn-primary">Buy Now</a></p>
              </td>
              <td class="text-center border-0">
                <h2 class="font-weight-light">Enterprise</h2>
                <p class="lead">Call us</p>
                <p><a href="https://pepiuox.net" class="btn btn-outline-primary">Contact</a></p>
              </td>
            </tr>
            <tr>
        ...
        <div class="row text-center">
          <div class="col-12">
            ...
            <div class="mt-2 mt-md-5 justify-content-center">
              <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="<?php echo SITE_PATH; ?>assets/images/customers/cisco.svg">
              <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="<?php echo SITE_PATH; ?>assets/images/customers/apple.svg">
              <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="<?php echo SITE_PATH; ?>assets/images/customers/ibm.svg">
              <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="<?php echo SITE_PATH; ?>assets/images/customers/intel.svg">
              <img alt="image" height="30" class="ml-3 mr-3 mb-2 mt-2" src="<?php echo SITE_PATH; ?>assets/images/customers/panasonic.svg">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-6">
            <div class="fdb-box fdb-touch">
              ...
              <p>
                <img alt="image" height="50" class="rounded-circle" src="<?php echo SITE_PATH; ?>assets/images/people/5.jpg">
          ...
          <div class="col-md-6 mt-4 mt-md-0">
            <div class="fdb-box fdb-touch">
              ...
              <p>
                <img alt="image" height="50" class="rounded-circle" src="<?php echo SITE_PATH; ?>assets/images/people/4.jpg">
                <strong class="ml-3">Person Name</strong>
              </p>
            </div>
          </div>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <section class="py-5 bg-dark">
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col">
            <img alt="image" height="40" class="ml-3 mr-3 mb-2 mt-2" src="<?php echo SITE_PATH; ?>assets/images/customers/adobe.svg">
            <img alt="image" height="40" class="ml-3 mr-3 mb-2 mt-2" src="<?php echo SITE_PATH; ?>assets/images/customers/amazon.svg">
            <img alt="image" height="40" class="ml-3 mr-3 mb-2 mt-2" src="<?php echo SITE_PATH; ?>assets/images/customers/ebay.svg">
            <img alt="image" height="40" class="ml-3 mr-3 mb-2 mt-2" src="<?php echo SITE_PATH; ?>assets/images/customers/samsung.svg">
            <img alt="image" height="40" class="ml-3 mr-3 mb-2 mt-2" src="<?php echo SITE_PATH; ?>assets/images/customers/orange.svg">
            <img alt="image" height="40" class="ml-3 mr-3 mb-2 mt-2" src="<?php echo SITE_PATH; ?>assets/images/customers/salesforce.svg">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="row mt-5 justify-content-center">
          <div class="col-md-8 col-lg-4 col-xl-3 m-auto text-center">
            <img alt="image" height="50" src="<?php echo SITE_PATH; ?>assets/images/customers/intel.svg">
          ...
          <div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center">
            <img alt="image" height="50" src="<?php echo SITE_PATH; ?>assets/images/customers/apple.svg">
          ...
          <div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center">
            <img alt="image" height="50" src="<?php echo SITE_PATH; ?>assets/images/customers/samsung.svg">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <section class="py-5" style="background-image: url(imgs/shapes/9.svg);">
      <div class="container">
        <div class="row text-center justify-content-center">
      ...
      <div class="container">
        ...
        <div class="row mt-5 justify-content-center">
          <div class="col-md-10 col-lg-3 ml-auto mr-auto text-center">
            ...
            <p><img alt="image" height="50" class="rounded-circle" src="<?php echo SITE_PATH; ?>assets/images/people/5.jpg"></p>
          ...
          <div class="col-md-10 col-lg-3 pt-5 pt-lg-0 ml-auto mr-auto text-center">
            ...
            <p><img alt="image" height="50" class="rounded-circle" src="<?php echo SITE_PATH; ?>assets/images/people/8.jpg"></p>
            <p class="lead"><strong>Person Name</strong></p>
            <p>Co-founder, Company</p>
          </div>
          ...
          <div class="col-md-10 col-lg-3 pt-5 pt-lg-0 ml-auto mr-auto text-center">
            ...
            <p><img alt="image" height="50" class="rounded-circle" src="<?php echo SITE_PATH; ?>assets/images/people/9.jpg"></p>
            <p class="lead"><strong>Person Name</strong></p>
            <p>Co-founder, Company</p>
          </div>
        </div>
