...
<html lang="en">
    <head>
        ...
        <title><?php echo SITE_NAME; ?> | <?php echo str_replace('_',' ',ucfirst($fname)); ?></title>
        <!-- Font Awesome -->
        <link href="<?php echo SITE_PATH; ?>assets/plugins/fontawesome/css/all.min.css" rel="stylesheet" type="text/css"/>        
        <!-- Theme style -->
        <link href="<?php echo SITE_PATH; ?>assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
        <link href="<?php echo SITE_PATH; ?>assets/plugins/adminlte/css/adminlte.min.css" rel="stylesheet" type="text/css"/>
