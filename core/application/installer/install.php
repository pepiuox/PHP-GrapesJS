...
if (!file_exists($serverfile)) {
    ...
    if (isset($_POST["Update"])) {
        ...
        if ($conn->query($update) === true) {
            $_SESSION["SuccessMessage"] = "The configuration is Updated. ";
...
include_once 'define.php';" . "\n\n";
        ...
        $filecontent .= "}" . "\n";
        $filecontent .= "\$fname = basename(\$_SERVER['REQUEST_URI']);" . "\n";
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>PHP GrapesJS</title>
    <link href="<?php echo $website; ?>assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet"
        type="text/css" />
    <link href="<?php echo $website; ?>assets/plugins/fontawesome-free/css/all.min.css" rel="stylesheet"
        type="text/css" />
                        ...
                        <div class="card-body">
                            <form method="post">
                                <div class="mb-3">
                                    ...
                                    <p>We recommend that you follow the steps carefully and verify that everything is
                                        correctly installed.
                                    </p>
                                </div>
                                <hr>
                                <?php if ($step == 1 && $_SESSION["StepInstall"] == 1) { ?>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <p>
                                        If you have already created the database, check the connection and continue with
                                        the
                                        installation of tables in the third step, otherwise create the table in the
                                        second
                                        step.
                                    </p>
                                </div>
                                <?php } elseif ($step == 2 || $_SESSION["StepInstall"] == 2) { ?>
                                <div class="alert alert-danger" role="alert">
                                    <h5>You don't have the <?php
        echo $_SESSION[
        "DBNAME"
        ];
    ?> database installed </h5>
                                </div>
                                <div class="mb-3">
                                    <div class="alert alert-primary text-center" role="alert">
                                        <h3>2.- Second step</h3>
                                ...
                                <div class="mb-3">
                                    ...
                                    <p>
                                        <strong> Server Host : <span class="text-primary"><?php
        echo $_SESSION[
        "DBHOST"
        ];
    ?></span></strong><br />
                                        <strong> Server User : <span class="text-primary"><?php
        echo $_SESSION[
        "DBUSER"
        ];
    ?></span></strong><br />
                                        <strong> Server Password : <span class="text-primary"> <?php
        echo $_SESSION[
        "DBPASSWORD"
        ];
    ?></span></strong><br />
                                        <strong> Database Name : <span class="text-danger"> <?php
        echo $_SESSION[
        "DBNAME"
        ];
    ?></span></strong>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox" value="yes" id="cdbn"
                                            name="cdbn">
                                ...
                                <div class="mb-3">
                                    ...
                                    <button name="createdb" type="submit" class="btn btn-primary">Create database
                                    </button>
                                </div>

                                <?php } elseif ($step == 3 || $_SESSION["StepInstall"] == 3) { ?>
                                <div class="alert alert-success" role="alert">
                                    <h5>Your DB is connected to <?php
        echo $_SESSION[
        "DBNAME"
        ];
    ?></h5>
        ...
        ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" style="width: 86%;"
                                            aria-valuenow="86" aria-valuemin="0" aria-valuemax="100">86%</div>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <h5 class="text-danger">We recommend you check if there are users with
                                        administration
                                        levels. </h5>
                                    <p>1.- Verify that there are no high-level users in the installation</p>
                                    <button class="btn btn-info" type="submit" name="verifyuser" id="verifyuser">Verify
                                        user
                                        admin</button>
                                    <p>2.- Deleted high-level users in the installation</p>
                                    <button class="btn btn-danger" type="submit" name="cleanuser" id="cleanuser">Clean
                                        user
                                        admin</button>
                                </div>
                                ...
                                <!-- /.col -->
                                <?php } elseif ($step == 6 || $_SESSION["StepInstall"] == 6) {
    ?>
                                <div class="alert alert-success" role="alert">
