...
<html lang="en">
    <head>
        ...
        <link href="' .
                $website .
                'assets/plugins/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
    <?php
        ...
        <script src="' .
                $website .
                'assets/js/popper.min.js" type="text/javascript"></script>   
    </body>
</html>  
<?php
        ...
        ?>
                                                                                                                ...
                                                                                                                <form method="post">
                                                                                                                    ...
                                                                                                                    <div class="form-group">
                                                                                                                        ...
                                                                                                                        <input type="text" class="form-control" id="DOMAIN_SITE" name="DOMAIN_SITE" value="<?php
        echo $confs[
        "DOMAIN_SITE"
        ];
        ?>">
