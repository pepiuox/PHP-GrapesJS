...
elseif($cspuser === 'services'){
	$typusr = 'servicios';
}
elseif($cspuser === 'products'){
	$typusr = 'productor';
}else{
            ...
            if (
                ...
                if ($password === $repassword) {
                    ...
                    $prof = $this->conn->prepare(
                        "INSERT INTO users_profiles(idp,usercode,usrtypes,mkhash) VALUES (?,?,?,?)"
                    );
                    $prof->bind_param("sss", $newid, $usrcod, $typusr, $enck);
                    $prof->execute();
