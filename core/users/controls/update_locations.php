...
$upry = $this->conn->prepare("SELECT name_location_1, address_1, name_location_2, address_2, name_location_3, address_3, name_location_4, address_4, name_location_5, address_5 FROM users_locations WHERE usercode = ?");
