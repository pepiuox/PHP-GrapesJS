...
$upro = $this->conn->prepare("SELECT public_phone, public_email, social_media, profession, occupation, profile_bio, language FROM users_profiles WHERE idp = ? AND usercode=?");
