...
<img src="<?php echo $pathf . '/' . $rpro["profile_image"]; ?>" class="card-img-top img-fluid" alt="<?php echo $rpro["firstname"] . " " . $rpro["lastname"]; ?>">
