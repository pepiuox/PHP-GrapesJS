...
<script src="<?php echo SITE_PATH; ?>assets/js/gallery.js" type="text/javascript"></script>
<link href="<?php echo SITE_PATH; ?>assets/css/gallery.css" rel="stylesheet" type="text/css"/>
