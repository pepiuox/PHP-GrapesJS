...
export default class PropertyFactory {
  constructor() {
    ...
    this.optsDir = getOptions([
      'row',
      'row-reverse',
      'column',
      'column-reverse',
    ]);
    this.opstDisplay = getOptions([
      'block',
      'inline',
      'inline-block',
      'flex',
    ...
    this.optsJustCont = getOptions([
      ...optsFlex,
      'space-between',
      'space-around',
      'space-evenly',
    ]);
    this.optsAlignCont = getOptions([
      ...optsFlex,
      'space-between',
      'space-around',
      'stretch',
  ...
  init() {
    ...
    [
      ...
      [
        'text-shadow-h',
        { type: typeNumber, default: '0', units: this.unitsSizeNoPerc },
      ],
      [
        'top',
        { default: 'auto', units: this.unitsSize, fixedValues },
        'text-shadow-h',
      ],
      ['right', {}, 'top'],
      ['bottom', {}, 'top'],
      ...
      [
        'font-size',
        { default: 'medium', fixedValues: this.fixedFontSizes },
        'width',
      ],
      [
        'letter-spacing',
        { default: 'normal', fixedValues: this.fixedLetSpace },
        'top',
      ],
      ...
      [
        'border-radius-c',
        { property: 'border-radius', fixedValues: undefined },
        'padding-top',
      ],
      ...
      [
        'transition-duration',
        { default: '2s', units: this.unitsTime },
        'border-radius-c',
      ],
      ...
      [
        'transform-scale-x',
        { default: '1', functionName: 'scaleX', units: undefined },
        'transform-rotate-x',
      ],
      ...
      [
        'order',
        { type: typeNumber, default: '0', requiresParent: requireFlex },
      ],
      ['flex-grow', {}, 'order'],
      ...
      [
        'float',
        { type: this.typeRadio, default: 'none', options: this.optsFloat },
      ],
      ...
      [
        'opacity',
        { type: this.typeSlider, default: '1', min: 0, max: 1, step: 0.01 },
      ],

      // Select types
      [
        'display',
        { type: this.typeSelect, default: 'block', options: this.opstDisplay },
      ],
      [
        'flex-direction',
        { default: 'row', options: this.optsDir, requires: requireFlex },
        'display',
      ],
      [
        'flex-wrap',
        { default: 'nowrap', options: this.optsWrap },
        'flex-direction',
      ],
      [
        'justify-content',
        { default: 'flex-start', options: this.optsJustCont },
        'flex-wrap',
      ],
      [
        'align-items',
        { default: 'stretch', options: this.optsFlexAlign },
        'flex-wrap',
      ],
      ...
      [
        'font-family',
        { default: 'Arial, Helvetica, sans-serif', options: this.optsFonts },
        'display',
      ],
      ['font-weight', { default: '400', options: this.optsWeight }, 'display'],
      [
        'border-style',
        { default: 'solid', options: this.optsBorderStyle },
        'display',
      ],
      [
        'box-shadow-type',
        { default: '', options: this.optsShadowType },
        'display',
      ],
      [
        'background-repeat',
        { default: 'repeat', options: this.optsBgRepeat },
        'display',
      ],
      [
        'background-position',
        { default: 'left top', options: this.optsBgPos },
        'display',
      ],
      [
        'background-attachment',
        { default: 'scroll', options: this.optsBgAttach },
        'display',
      ],
      [
        'background-size',
        { default: 'auto', options: this.optsBgSize },
        'display',
      ],
      [
        'transition-property',
        { default: 'width', options: this.optsTransitProp },
        'display',
      ],
      [
        'transition-timing-function',
        { default: 'ease', options: this.optsTransitFn },
        'display',
      ],
      ['cursor', { default: 'auto', options: this.optsCursor }, 'display'],
      [
        'overflow',
        { default: 'visible', options: this.optsOverflow },
        'display',
      ],
      ['overflow-x', {}, 'overflow'],
      ['overflow-y', {}, 'overflow'],
