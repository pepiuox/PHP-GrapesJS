...
<div class="login-box">
        ...
        <div class="card-body login-card-body">
            ...
            <form action="login.php" method="post" class="form-inline d-flex justify-content-center">
                ...
                <div class="input-group mb-3">
                    <input type="email" class="form-control" name="email" id="email" placeholder="<?php echo $lang['email']; ?>" autocomplete="off"
                           required autofocus>
  ...
  <label class="form-check-label" for="remember">
    <?php echo $lang['remember_me']; ?>
                    ...
                    <!-- /.col -->
                    <div class="mb-3">
                        <button type="submit" name="signin" id="signin" class="btn btn-primary btn-block"><?php echo $lang['sign_in']; ?></button>
                    </div>
                    <!-- /.col -->
                </div>
            </form>
