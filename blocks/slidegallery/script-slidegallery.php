...
<script src="<?php echo $base; ?>assets/js/slidegallery.js" type="text/javascript"></script>
<link href="<?php echo $base; ?>assets/css/slidegallery.css" rel="stylesheet" type="text/css"/>
