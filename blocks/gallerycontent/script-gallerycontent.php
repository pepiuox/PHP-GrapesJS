...
<script src="<?php echo $base; ?>assets/js/gallerycontent.js" type="text/javascript"></script>
<link href="<?php echo $base; ?>assets/css/gallerycontent.css" rel="stylesheet" type="text/css"/>
