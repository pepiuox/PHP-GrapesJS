...
<script src="<?php echo SITE_PATH; ?>assets/js/multimedia.js" type="text/javascript"></script>
<link href="<?php echo SITE_PATH; ?>assets/css/multimedia.css" rel="stylesheet" type="text/css"/>
