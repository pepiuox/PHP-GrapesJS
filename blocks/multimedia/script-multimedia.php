...
<script src="<?php echo $base; ?>assets/js/multimedia.js" type="text/javascript"></script>
<link href="<?php echo $base; ?>assets/css/multimedia.css" rel="stylesheet" type="text/css"/>
