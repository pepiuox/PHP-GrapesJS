...
if ($num_ct > 0) {
    ...
    <script src="<?php echo $base; ?>js/jquery.ui.widget.js" type="text/javascript"></script>
    <script src="<?php echo $base; ?>js/froogaloop.js" type="text/javascript"></script>
    <script src="<?php echo $base; ?>js/jquery.dcd.video.js" type="text/javascript"></script>
