    ...
    <div class="container">
        <div class="row pt-3">
            <table class="table">
                <thead>
                    <tr>
                        <th><a id="addrow" name="addrow" title="Agregar" class="btn btn-primary" href="dashboard.php?cms=crud&w=add&tbl=menu_options">Agregar <i class="fa fa-plus-square"></i></a></th><th>Id</th><th>Id menu</th><th>Fluid</th><th>Placement</th><th>Aligment</th><th>Background</th><th>Color</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
            ...
            <div class="col-md-12">
                <div class="row pt-3">
                    <form role="form" id="add_menu_options" method="POST">
                        ...
                        <div class="form-group">
                            <button type="submit" id="addrow" name="addrow" class="btn btn-primary"><span class = "glyphicon glyphicon-plus"></span> Add</button>
                        </div>
                    </form>
                </div>
            </div>
