    ...
    <div class="container">
        <div class="row">
            <div class="col-6 p-0 pr-1">
                <img class="img-fluid d-block" src="<?php echo $base; ?>assets/images/img-placeholder-1.svg">
            </div>
            <div class="col-6 p-0 pl-1">
                <img class="img-fluid d-block rounded-circle" src="<?php echo $base; ?>assets/images/img-placeholder-3.svg">
            </div>
        </div>
    </div>
</li>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="carousel slide" data-ride="carousel" id="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active"> <img class="d-block img-fluid w-100" src="<?php echo $base; ?>assets/images/cover-bubble-dark.svg">
                <div class="carousel-caption">
                    <h5 class="m-0">Carousel</h5>
                    <p>with controls</p>
                </div>
            </div>
            <div class="carousel-item"> <img class="d-block img-fluid w-100" src="<?php echo $base; ?>assets/images/cover-bubble-light.svg">
                <div class="carousel-caption">
                    <h5 class="m-0">Carousel</h5>
                    <p>with controls</p>
                </div>
            </div>
            <div class="carousel-item"> <img class="d-block img-fluid w-100" src="<?php echo $base; ?>assets/images/cover-moon.svg">
                <div class="carousel-caption">
                    <h5 class="m-0">Carousel</h5>
                    <p>with controls</p>
                </div>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active"> <img class="d-block img-fluid w-100" src="<?php echo $base; ?>assets/images/cover-moon.svg">
                <div class="carousel-caption">
                    <h5 class="m-0">Carousel</h5>
                    <p>with indicators</p>
                </div>
            </div>
            <div class="carousel-item "> <img class="d-block img-fluid w-100" src="<?php echo $base; ?>assets/images/cover-bubble-dark.svg">
                <div class="carousel-caption">
                    <h5 class="m-0">Carousel</h5>
                    <p>with indicators</p>
                </div>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="pi-draggable embed-responsive embed-responsive-16by9">
        <video src="<?php echo $base; ?>assets/images/video-placeholder.mp4" class="embed-responsive-item" controls="controls"> Your browser does not support HTML5 video. </video>
    </div>
</li>
