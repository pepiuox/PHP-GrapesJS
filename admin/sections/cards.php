...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="card"> <img class="card-img-top" src="<?php echo $_SESSION['base']; ?>assets/images/cover-moon.svg" alt="Card image cap">
        <div class="card-body">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="card text-center"> <img class="card-img-top" src="<?php echo $_SESSION['base']; ?>assets/images/cover-bubble-light.svg" alt="Card image cap">
        <div class="card-body">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="card">
        ...
        <img class="card-img-bottom" src="<?php echo $_SESSION['base']; ?>assets/images/cover-bubble-dark.svg" alt="Card image cap">
    </div>
</li>
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="card">
        <img class="card-img-top" src="<?php echo $_SESSION['base']; ?>assets/images/cover-moon.svg" alt="Card image cap">
        <div class="card-body">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="card"> <img class="card-img" src="<?php echo $_SESSION['base']; ?>assets/images/cover-bubble-light.svg" alt="Card image">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="card">
        <img class="card-img" src="<?php echo $_SESSION['base']; ?>assets/images/cover-moon.svg" alt="Card image">
