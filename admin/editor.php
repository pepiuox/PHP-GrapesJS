        ...
        if (isset($_GET['id'])) {
            ...
            <html lang="en">
                <head>
                    ...
                    <link rel="stylesheet" href="<?php echo $base; ?>css/next-sidebar.css" />
                    <link rel="stylesheet" href="<?php echo $base; ?>css/perfect-scrollbar.css" />
                    <script>
                        ...
                        <div class="container-fluid">
                            ...
                            <div id="navbarNavDropdown" class="navbar-collapse collapse
                                ...
                                <ul class="navbar-nav nav-pills nav-fill">
                                    <li class="nav-item">
                                        <a class="nav-link" href="list.php">Page list</a>
                                    </li>
                                    <li class="nav-item">
