        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-3 order-3 order-md-1"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-1.svg"> </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-3 offset-lg-1"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-2.svg"> </div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-4 col-lg-3 order-2 order-md-1 p-0"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-3.svg"> </div>
    ...
    <div class="py-5">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-mobile.svg"> </div>
            </div>
        </div>
    </div>
</li>
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6 order-2 order-md-1"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-tablet.svg"> </div>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="py-5 text-center text-white" style="background-image: url('<?php echo $base; ?>img/cover-moon.svg');background-size:cover;background-position:center top;">
        <div class="container">
            <div class="row">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="pt-5" style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, .75), rgba(0, 0, 0, .75)), url(<?php echo $base; ?>img/cover-bubble-dark.svg); background-position: center center, center center;  background-size: 100%, 100%;  background-repeat: repeat, repeat;">
        <div class="container">
            <div class="row">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="py-5 text-center bg-primary">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 p-0"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/cover-bubble-light.svg" width="1500"> </div>
            </div>
        </div>
    </div>
</li>
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="py-5" style="background-image: url('<?php echo $base; ?>img/cover-stripes.svg');  background-size: cover;background-position:center bottom;">
        <div class="container">
            <div class="row">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="pt-5 pb-5 pb-md-0 text-center text-white" style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, .75), rgba(0, 0, 0, .75)), url(<?php echo $base; ?>img/cover-bubble-dark.svg); background-position: center center, center center;  background-size: 100%, 100%;  background-repeat: repeat, repeat;">
        <div class="container">
            <div class="row">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    ...
    <div class="py-5 text-center" style="background-image: url('<?php echo $base; ?>img/cover-bubble-light.svg');background-size:cover;">
        <div class="container">
            <div class="row">
