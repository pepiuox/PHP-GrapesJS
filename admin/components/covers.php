        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 mx-auto">
                    ...
                    <p class="lead mb-0">I am alone, and feel the charm of existence in this spot.</p> <a class="btn btn-link m-3" href="#">Read more</a> <a class="btn btn-primary m-3" href="#">Buy now</a> <img class="img-fluid d-block mx-auto" src="<?php echo $base; ?>assets/images/img-placeholder-tablet.svg"
                                                                                                                                                                                                        width="750"> </div>
            </div>
        </div>
    </div>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="py-5 text-center text-white" style="position: relative; overflow: hidden;"> <video autoplay="" loop="" muted="" plays-inline="" style="position: absolute; right: 0; top: 0; min-width:100%; z-index: -100;">
            <source src="<?php echo $base; ?>assets/images/video-placeholder.mp4" type="video/mp4"> </video>
        <div class="container py-5">
            <div class="row">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="py-5 text-center text-md-right pi-draggable" style="background-image: url(<?php echo $base; ?>assets/images/cover-bubble-dark.svg);	background-position: right bottom;	background-size: cover;	background-repeat: repeat; background-attachment: fixed;">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 p-0">
                    <div class="embed-responsive embed-responsive-4by3"> <video src="<?php echo $base; ?>assets/images/video-placeholder.mp4" class="embed-responsive-item" type="video/mp4" controls="controls">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="pt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-4 mr-auto order-2 order-md-1"> <img class="img-fluid d-block" src="<?php echo $base; ?>assets/images/img-placeholder-mobile.svg"> </div>
    ...
    <div class="py-5">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6"> <img class="img-fluid d-block" src="<?php echo $base; ?>assets/images/img-placeholder-tablet.svg"> </div>
            </div>
        </div>
    </div>
</li>
