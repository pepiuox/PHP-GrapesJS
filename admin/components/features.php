    ...
    <div class="py-5">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 p-4">
                    <div class="row">
                        <div class="col-3 p-0 d-flex align-items-center"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-1.svg"> </div>
                        <div class="col-9">
                ...
                <div class="col-lg-4 col-md-6 p-4">
                    <div class="row">
                        <div class="col-3 p-0 d-flex align-items-center"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-4.svg"> </div>
                        <div class="col-9">
                ...
                <div class="col-lg-4 col-md-6 p-4">
                    <div class="row">
                        <div class="col-3 p-0 d-flex align-items-center"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-2.svg"> </div>
                        <div class="col-9">
                ...
                <div class="col-lg-4 col-md-6 p-4">
                    <div class="row">
                        <div class="col-3 p-0 d-flex align-items-center"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-3.svg"> </div>
                        <div class="col-9">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-md-6 p-3">
                    <div class="row">
                        <div class="col-3 p-0"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-1.svg"> </div>
                        <div class="col-9">
                            <p class="lead mb-1"> <b>#1</b> </p>
                            <p class="mb-0">A wonderful serenity has taken possession of my entire soul.</p>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 p-3">
                    <div class="row">
                        <div class="col-3 p-0"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-4.svg"> </div>
                        <div class="col-9">
                            <p class="lead mb-1"> <b>#2</b> </p>
                            <p class="mb-0">I am alone, and feel the charm of existence in this spot.</p>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 p-3">
                    <div class="row">
                        <div class="col-3 p-0"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-2.svg"> </div>
                        <div class="col-9">
                            <p class="lead mb-1"> <b>#3</b> </p>
                            <p class="mb-0">I should be incapable of drawing a single stroke.</p>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 p-3">
                    <div class="row">
                        <div class="col-3 p-0"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-3.svg"> </div>
                        <div class="col-9">
                            <p class="lead mb-1"> <b>#4</b> </p>
                            <p class="mb-0">I throw myself down among the tall grass by the trickling stream.</p>
                        </div>
    ...
    <div class="py-4 text-center">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 p-3">
                    <div class="card">
                        <div class="card-body p-4"> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="<?php echo $base; ?>img/img-placeholder-3.svg" width="150">
                            <h1>One</h1>
                            <p class="mb-0">A wonderful serenity has taken possession of my entire soul.</p>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 p-3 col-md-6">
                    <div class="card">
                        <div class="card-body p-4"> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="<?php echo $base; ?>img/img-placeholder-2.svg" width="150">
                            <h1>Two</h1>
                ...
                <div class="col-lg-4 p-3 col-md-6">
                    <div class="card">
                        <div class="card-body p-4"> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="<?php echo $base; ?>img/img-placeholder-1.svg" width="150">
                            <h1>Three</h1>
                            <p class="mb-0">I should be incapable of drawing a single stroke.</p>
                        </div>
                    </div>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="py-3">
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-6 p-3"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/cover-bubble-dark.svg">
                    <h2 class="my-3"><b>One&nbsp;</b> </h2>
                    <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                </div>
                <div class="col-md-4 col-6 p-3"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/cover-moon.svg">
                    <h2 class="my-3"> <b>Two</b> </h2>
                    <p>I am alone, and feel the charm of existence in this spot, which was created for the bliss of souls like mine. I am so happy, my dear friend.</p>
                </div>
                <div class="col-md-4 col-6 p-3"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/cover-bubble-light.svg">
                    <h2 class="my-3"> <b>Three</b> </h2>
                    <p>So absorbed in the exquisite sense of mere tranquil existence, that I neglect my talents. I should be incapable of drawing a single stroke.</p>
                </div>
            </div>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="pt-5 pb-3 text-center">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 col-6 p-4"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-1.svg" width="1500">
                    <h4 class="mt-3 mb-0"> <b>One&nbsp;</b> </h4>
                </div>
                <div class="col-md-3 col-6 p-4"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-4.svg" width="1500">
                    <h4 class="mt-3 mb-0"> <b>Two</b> </h4>
                </div>
                <div class="col-md-3 col-6 p-4"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-2.svg" width="1500">
                    <h4 class="mt-3 mb-0"> <b>Three</b> </h4>
                </div>
                <div class="col-md-3 col-6 p-4"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-3.svg" width="1500">
            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <div class="row text-center">
                        <div class="col-md-3 col-6 p-3"> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="<?php echo $base; ?>img/img-placeholder-3.svg" width="150">
                            <p class="mb-0 lead"> <b>One</b> </p>
                        </div>
                        <div class="col-md-3 col-6 p-3"> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="<?php echo $base; ?>img/img-placeholder-4.svg" width="150">
                            <p class="mb-0 lead"> <b>Two</b> </p>
                        </div>
                        <div class="col-md-3 col-6 p-3"> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="<?php echo $base; ?>img/img-placeholder-2.svg" width="150">
                            <p class="mb-0 lead"> <b>Three</b> </p>
                        </div>
                        <div class="col-md-3 col-6 p-3"> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="<?php echo $base; ?>img/img-placeholder-1.svg" width="150">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-6 p-3 text-center">
                    <div class="row">
                        <div class="col-md-4 p-2"> <img class="img-fluid d-block mb-2 mx-auto rounded-circle" src="<?php echo $base; ?>img/img-placeholder-3.svg" width="100">
                            <p class="mb-0 lead"> <a href="#">One</a> </p>
                        </div>
                        <div class="col-md-4 p-2"> <img class="img-fluid d-block mb-2 mx-auto rounded-circle" src="<?php echo $base; ?>img/img-placeholder-2.svg" width="100">
                            <p class="mb-0 lead"> <a href="#">Two</a> </p>
                        </div>
                        <div class="col-4 p-2"> <img class="img-fluid d-block mb-2 mx-auto rounded-circle" src="<?php echo $base; ?>img/img-placeholder-1.svg" width="100">
                            <p class="mb-0 lead"> <a href="#">Three</a> </p>
                        </div>
                        <div class="col-4 p-2"> <img class="img-fluid d-block mb-2 mx-auto rounded-circle" src="<?php echo $base; ?>img/img-placeholder-1.svg" width="100">
                            <p class="mb-0 lead"> <a href="#">Four</a> </p>
                        </div>
                        <div class="col-4 p-2"> <img class="img-fluid d-block mb-2 mx-auto rounded-circle" src="<?php echo $base; ?>img/img-placeholder-4.svg" width="100">
                            <p class="mb-0 lead"> <a href="#">Five</a> </p>
                        </div>
                        <div class="col-4 p-2"> <img class="img-fluid d-block mb-2 mx-auto rounded-circle" src="<?php echo $base; ?>img/img-placeholder-3.svg" width="100">
    ...
    <div class="py-5">
        <div class="container">
            ...
            <div class="row d-flex justify-content-between">
                <div class="col-md-6 col-lg-5 p-4"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-1.svg" width="1500">
                ...
                <div class="col-md-6 col-lg-5 p-4"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-2.svg" width="1500">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="py-5">
        <div class="container">
            ...
            <div class="row d-flex justify-content-between">
                <div class="col-md-4 col-lg-3 p-4"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-1.svg" width="1500">
                    <h4 class="my-3"> <b>One&nbsp;</b> </h4>
                    <p>I should be incapable of drawing a single stroke at the present moment; and yet I feel that I never was a greater artist than now.</p>
                </div>
                <div class="col-md-4 col-lg-3 p-4"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-2.svg" width="1500">
                ...
                <div class="col-md-4 col-lg-3 p-4"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-3.svg" width="1500">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-6 p-md-4 col-3"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-1.svg" width="1500"> </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-6 p-md-4 col-3 offset-lg-1 order-1 order-md-2"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-2.svg" width="1500"> </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-5 col-md-6 p-md-4 col-3"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-3.svg" width="1500"> </div>
                        <div class="col-md-6 offset-lg-1 d-flex flex-column justify-content-center py-4">
                            <h2 class="my-3"> <b>Three</b> </h2>
        ...
        <div class="container">
            <div class="row">
                <div class="text-center mx-auto col-lg-8">
                    ...
                    </div> <img class="img-fluid d-block" src="<?php echo $base; ?>img/cover-bubble-light.svg">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 text-center mx-auto">
                    <h2 class="mb-4">I enjoy with my whole heart</h2> <img class="img-fluid d-block" src="<?php echo $base; ?>img/cover-moon.svg">
                    <div class="row justify-content-center">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 text-center mx-auto">
                    ...
                    </div> <img class="img-fluid d-block" src="<?php echo $base; ?>img/cover-moon.svg"> </div>
            </div>
        </div>
    </div>
</li>
        ...
        <div class="container">
            <div class="row">
                <div class="mx-auto col-md-12 px-4">
                    ...
                    <p class="lead mb-4">So absorbed in the exquisite sense of mere tranquil existence, that I neglect my talents. I should be incapable of drawing a single stroke at the present moment.</p> <img class="img-fluid d-block" src="<?php echo $base; ?>img/cover-bubble-dark.svg">          </div>
            </div>
            <div class="row justify-content-center">
        ...
        <div class="container">
            <div class="row">
                <div class="mx-auto col-md-12">
                    <h2>A wonderful serenity</h2>
                    <p class="lead mb-4">It has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the charm of existence in this spot.</p> <img class="img-fluid d-block" src="<?php echo $base; ?>img/cover-bubble-light.svg">
                    <div class="row justify-content-center">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="py-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 p-0"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/cover-bubble-dark.svg" width="1500"> </div>
            </div>
        </div>
    </div>
</li>
    ...
    <div class="py-3">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 p-lg-5 p-3"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-1.svg" width="1500"> </div>
            </div>
            <div class="row">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="py-5">
        <div class="container">
            <div class="row">
                <div class="order-2 order-md-1 col-md-5"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-tablet.svg"> </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 d-flex flex-column align-items-start justify-content-center p-3">
                    <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-tablet.svg"> </div>
            </div>
        </div>
    </div>
</li>
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 order-2 order-lg-1"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-tablet.svg"> </div>
    ...
    <div class="py-5">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-tablet.svg"> </div>
            </div>
        </div>
    </div>
</li>
    ...
    <div class="pt-5">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 mx-auto order-3 order-lg-2"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-mobile.svg"> </div>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="pt-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 col-7 mx-auto order-2 order-lg-1"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-mobile.svg"> </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 p-4 d-flex justify-content-center flex-column">
                    ...
                    <div class="row my-3">
                        <div class="col-3"> <img class="img-fluid d-block rounded-circle" src="<?php echo $base; ?>img/img-placeholder-1.svg"> </div>
                        <div class="col-8 d-flex align-items-center">
                            <p class="mb-0">I often think with longing, Oh, would I could describe these conceptions, could impress upon paper.</p>
                        </div>
                    </div>
                    <div class="row my-3">
                        <div class="col-3 order-1 order-md-2"> <img class="img-fluid d-block rounded-circle" src="<?php echo $base; ?>img/img-placeholder-2.svg"> </div>
                ...
                <div class="col-lg-5 col-8 mx-auto d-flex justify-content-center flex-column"> <img class="img-fluid d-block" src="<?php echo $base; ?>img/img-placeholder-mobile.svg"> </div>
            </div>
        </div>
    </div>
</li>
