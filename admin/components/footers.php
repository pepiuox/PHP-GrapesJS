            ...
            <div class="row">
                <div class="col-md-12 text-center d-md-flex justify-content-between align-items-center">
                    <ul class="nav d-flex justify-content-center">
                        ...
                        <li class="nav-item"> <a class="nav-link" href="#">Pricing</a> </li>
                        <li class="nav-item"> <a class="nav-link" href="#">About</a> </li>
                    </ul> <a class="btn btn-primary" href="#">Contact us</a> </div>
            </div>
        </div>
    </div>
</li>
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <form class="form-inline">
                        <div class="form-group"> <input type="email" class="form-control" placeholder="Your e-mail here"> </div> <button type="submit" class="btn btn-primary ml-3">Subscribe</button> </form>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="p-4 col-md-3">
                    ...
                    <form>
                        <fieldset class="form-group"> <label for="exampleInputEmail1">Get our newsletter</label> <input type="email" class="form-control" placeholder="Enter email"> </fieldset> <button type="submit" class="btn btn-outline-dark">Submit</button> </form>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="f-about">
                            <div class="footer-logo">
                                <a href="javascript:void(0)">
                                    <img src="<?php echo $base; ?>assets/images/footer/logo.svg" alt="Logo" />
                                </a>
                            </div>
                            <p class="text">
                        ...
                        <div class="footer-app-store">
                            ...
                            <ul>
                                <li>
                                    <a href="javascript:void(0)">
                                        <img
                                            src="<?php echo $base; ?>assets/images/footer/app-store.svg"
                                            alt="app"
                                            />
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                        <img
                                            src="<?php echo $base; ?>assets/images/footer/play-store.svg"
                                            alt="play"
                                            />
                                    </a>
                                </li>
                    ...
                    <div class="col-xl-2 col-lg-3 col-sm-4">
                        ...
                        <div class="footer-contact">
                            ...
                            <ul>
                                ...
                                <li><i class="lni lni-envelope"></i> support@uideck.com</li>
                            </ul>
                        </div>
                        <!-- End Footer Contact -->
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div
                            ...
                            "
                            >
                            <p class="text">Copyright © 2021 PHP GrapesJS. All Rights Reserved</p>
                            <ul class="social">
                                <li>
                                    <a href="javascript:void(0)">
