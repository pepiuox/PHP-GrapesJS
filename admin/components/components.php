...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <img class="img-fluid d-block" src="<?php echo $_SESSION['base']; ?>assets/images/photo-1.jpg">
</li>
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div id="carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active"> <img class="d-block img-fluid w-100" src="<?php echo $_SESSION['base']; ?>assets/images/photo-1.jpg">
                <div class="carousel-caption">
                    <h3>First slide label</h3>
                    <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
                </div>
            </div>
            <div class="carousel-item"> <img class="d-block img-fluid w-100" src="<?php echo $_SESSION['base']; ?>assets/images/photo-1.jpg">
                <div class="carousel-caption">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="embed-responsive embed-responsive-4by3"> <video src="<?php echo $_SESSION['base']; ?>assets/images/video-placeholder.mp4" class="embed-responsive-item" controls="controls">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="card"> <img class="card-img-top" src="<?php echo $_SESSION['base']; ?>assets/images/photo-1.jpg" alt="Card image cap">
        <div class="card-body">
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="card"> <img class="card-img" src="<?php echo $_SESSION['base']; ?>assets/images/photo-1.jpg" alt="Card image">
