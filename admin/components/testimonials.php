...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="pi-draggable py-5 text-white" style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, .75), rgba(0, 0, 0, .75)), url(<?php echo $base; ?>img/cover-bubble-dark.svg);  background-position: center center, center center;  background-size: cover, cover;  background-repeat: repeat, repeat;">
        <div class="container">
            <div class="row">
    ...
    <div class="py-5">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2 mx-auto p-3"> <img class="img-fluid d-block rounded-circle" src="<?php echo $base; ?>img/img-placeholder-2.svg"> </div>
            </div>
        </div>
    </div>
</li>
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <div class="py-5" style="background-image: url(<?php echo $base; ?>img/cover-bubble-dark.svg); background-position: right bottom;  background-size: cover; background-repeat: repeat; background-attachment: fixed;">
        <div class="container">
            <div class="row">
                <div class="ml-auto p-3 col-md-2 bg-white"> <img class="img-fluid d-block rounded-circle" src="<?php echo $base; ?>img/img-placeholder-1.svg"> </div>
                ...
                <div class="col-md-6 p-3">
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-3"> <img class="img-fluid d-block rounded-circle" src="<?php echo $base; ?>img/img-placeholder-2.svg"> </div>
                ...
                <div class="ml-auto col-md-6 p-3">
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-3"> <img class="img-fluid d-block rounded-circle" src="<?php echo $base; ?>img/img-placeholder-3.svg"> </div>
                                <div class="col-lg-10 col-9 d-flex align-items-center">
            ...
            <div class="row">
                <div class="ml-auto col-lg-5">
                    <div class="card my-2">
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="col-md-4"> <img class="img-fluid d-block rounded-circle mb-3" src="<?php echo $base; ?>img/img-placeholder-3.svg"> </div>
                ...
                <div class="mr-auto col-lg-5">
                    <div class="card my-2">
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="col-md-4"> <img class="img-fluid d-block rounded-circle mb-3" src="<?php echo $base; ?>img/img-placeholder-1.svg"> </div>
                                <div class="d-flex flex-column col-md-8 text-dark">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 p-3">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="col-md-4 col-3"> <img class="img-fluid d-block rounded-circle" src="<?php echo $base; ?>img/img-placeholder-2.svg"> </div>
                ...
                <div class="col-lg-4 col-md-6 p-3">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="col-md-4 col-3"> <img class="img-fluid d-block rounded-circle" src="<?php echo $base; ?>img/img-placeholder-1.svg"> </div>
                                <div class="d-flex  col-md-8 flex-column justify-content-center align-items-start col-9">
                ...
                <div class="col-lg-4 p-3">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="col-md-4 col-3"> <img class="img-fluid d-block rounded-circle" src="<?php echo $base; ?>img/img-placeholder-3.svg"> </div>
                                <div class="d-flex  col-md-8 flex-column justify-content-center align-items-start col-9">
