        ...
        <html lang="en">
            <head>
               ...
               -->
                ...
                <link href="../assets/plugins/grapesjs/css/grapesjs-component-code-editor.min.css" rel="stylesheet" type="text/css"/>
                <link rel="stylesheet" href="../assets/plugins/grapesjs/css/tooltip.css">
                <link rel="stylesheet" href="../assets/plugins/grapesjs/css/grapesjs-plugin-filestack.css">
                ...
                <link href="../assets/plugins/grapesjs/css/grapesjs-project-manager.min.css" rel="stylesheet">
                <!--  script  -->
                ...
                <script src="../assets/plugins/grapesjs/js/grapesjs-bootstrap-elements.js"></script>                               
                <script src="../assets/plugins/grapesjs/js/grapesjs-preset-webpage.min.js"></script>
                <script src="../assets/plugins/grapesjs/js/grapesjs-lory-slider.min.js"></script>
                <script src="../assets/plugins/grapesjs/js/grapesjs-tabs.min.js"></script>
                <script src="../assets/plugins/grapesjs/js/grapesjs-component-code-editor.min.js" type="text/javascript"></script>
                <script src="../assets/plugins/grapesjs/js/grapesjs-custom-code.min.js"></script>
                <script src="../assets/plugins/grapesjs/js/grapesjs-touch.min.js"></script>
                <script src="../assets/plugins/grapesjs/js/grapesjs-parser-postcss.min.js"></script>
                <script src="../assets/plugins/grapesjs/js/grapesjs-tooltip.min.js"></script>
                <script src="../assets/plugins/grapesjs/js/grapesjs-tui-image-editor.min.js"></script>
                <script src="../assets/plugins/grapesjs/js/grapesjs-navbar.min.js"></script>
                ...
                <script src="../assets/plugins/grapesjs/js/grapesjs-script-editor.min.js" type="text/javascript"></script>
                <script src="../assets/plugins/grapesjs/js/grapesjs-typed.js"></script>
                <script src="../assets/plugins/grapesjs/js/grapesjs-uikit.min.js"></script>
                <script src="../assets/plugins/grapesjs/js/grapesjs-page-break.min.js"></script>                
                <script src="../assets/plugins/grapesjs/js/grapesjs-project-manager.min.js"></script>
                <script src="../assets/plugins/grapesjs/js/grapesjs-ga.min.js"></script>
                <script src="../assets/plugins/grapesjs/js/grapesjs-parser-postcss.min.js"></script>
                <script src="../assets/plugins/grapesjs/js/grapesjs-swiper-slider.min.js"></script>
                <script>
