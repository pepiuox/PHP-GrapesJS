...
<body>
  ...
  <div class="card pi-draggable"> <img class="card-img-top" src="https://static.pingendo.com/cover-moon.svg" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card text-center pi-draggable"> <img class="card-img-top" src="https://static.pingendo.com/cover-bubble-light.svg" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card pi-draggable"> <img class="card-img" src="https://static.pingendo.com/cover-bubble-light.svg" alt="Card image">
  ...
  <div class="card text-center pi-draggable">
    <div class="card-header">
      <ul class="nav nav-tabs card-header-tabs">
        <li class="nav-item">
          <a class="nav-link active" data-toggle="tab" data-target="#tabone">Tab 1</a>
        </li>
        <li class="nav-item">
  ...
  <div class="card text-white bg-primary mb-3 pi-draggable">
    <div class="card-header">Header</div>
    <div class="card-body">
  ...
  <div class="card text-white bg-secondary mb-3 pi-draggable">
    <div class="card-header">Header</div>
    <div class="card-body">
  ...
  <div class="card text-white bg-info mb-3 pi-draggable">
    <div class="card-header">Header</div>
    <div class="card-body">
  ...
  <div class="card bg-light mb-3 pi-draggable">
    <div class="card-header">Header</div>
    <div class="card-body">
  ...
  <div class="card text-white bg-dark mb-3 pi-draggable">
    <div class="card-header">Header</div>
    <div class="card-body">
