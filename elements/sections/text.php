...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <p>Paragraph. Then, my friend, when darkness overspreads my eyes, and heaven and earth seem to dwell in my soul and absorb its power, like the form of a beloved mistress, then I often think with longing.</p>
</li>
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <h6>Heading 6</h6>
</li>
...
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <h4>Heading 4 <span class="badge badge-pill badge-warning">!</span></h4>
</li>
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <h3>Heading 3 <span class="badge badge-light"> New</span></h3>
</li>
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <h2>Heading 2 <small class="text-muted">subtitle</small></h2>
</li>
<li class="pi-draggable" draggable="true" ondragstart="return dragStart(event)">
    <h1 >Heading 1</h1>
</li>
