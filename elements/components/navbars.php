<nav class="navbar navbar-light pi-draggable">
...
<nav class="navbar navbar-expand-md navbar-light pi-draggable">
...
<nav class="navbar navbar-expand-md pi-draggable navbar-light">
    <div class="container"> <a class="navbar-brand text-primary" href="#">
        ...
        <div class="collapse navbar-collapse" id="navbar4">
            ...
            </ul> <a class="btn navbar-btn ml-md-2 btn-light">Contact us</a> </div>
    </div>
</nav>
<nav class="navbar navbar-expand-lg navbar-light pi-draggable">
    <div class="container"> <a class="navbar-brand text-primary" href="#">
            <i class="fa d-inline fa-lg fa-circle-o"></i>
            <b> BRAND</b>
...
<nav class="navbar navbar-dark bg-dark pi-draggable">
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark pi-draggable">
...
<nav class="navbar navbar-expand-md pi-draggable navbar-dark bg-dark">
    <div class="container"> <a class="navbar-brand" href="#">
            <i class="fa d-inline fa-lg fa-stop-circle"></i>
            <b> BRAND</b>
        ...
        <div class="collapse navbar-collapse" id="navbar10">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"> <a class="nav-link" href="#">About</a> </li>
                <li class="nav-item"> <a class="nav-link" href="#">FAQ</a> </li>
            </ul> <a class="btn navbar-btn ml-md-2 btn-light text-dark">Contact us</a> </div>
    </div>
</nav>
<nav class="navbar navbar-expand-lg pi-draggable navbar-dark bg-dark">
    <div class="container"> <a class="navbar-brand" href="#">
            <i class="fa d-inline fa-lg fa-circle-o"></i>
            <b> BRAND</b>
        ...
        <div class="collapse navbar-collapse" id="navbar11">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"> <a class="nav-link" href="#">About</a> </li>
                <li class="nav-item"> <a class="nav-link" href="#">FAQ</a> </li>
            </ul> <a class="btn btn-primary navbar-btn ml-md-2">Contact us</a> </div>
    </div>
</nav>
<nav class="navbar navbar-expand-md pi-draggable navbar-dark bg-dark">
...
<nav class="navbar navbar-expand-lg pi-draggable bg-dark navbar-dark">
...
<nav class="navbar pi-draggable bg-primary navbar-dark">
    <div class="container"> <a class="navbar-brand" href="#">
            <i class="fa d-inline fa-lg fa-circle" ></i>
            <b> BRAND</b>
        </a> </div>
</nav>
<nav class="navbar navbar-dark pi-draggable bg-primary">
    <div class="container d-flex justify-content-center"> <a class="navbar-brand" href="#">
            <i class="fa d-inline fa-lg fa-circle-o"></i>
            <b> BRAND</b>
        </a> </div>
</nav>
<nav class="navbar navbar-expand-md navbar-dark pi-draggable bg-primary">
...
<nav class="navbar navbar-expand-md pi-draggable navbar-dark bg-primary">
    <div class="container"> <a class="navbar-brand" href="#">
            <i class="fa d-inline fa-lg fa-stop-circle"></i>
            <b> BRAND</b>
...
<nav class="navbar navbar-expand-lg pi-draggable navbar-dark bg-primary">
    <div class="container"> <a class="navbar-brand" href="#">
            <i class="fa d-inline fa-lg fa-circle-o"></i>
            <b> BRAND</b>
        ...
        <div class="collapse navbar-collapse" id="navbar17">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"> <a class="nav-link" href="#">About</a> </li>
                <li class="nav-item"> <a class="nav-link" href="#">FAQ</a> </li>
            </ul> <a class="btn btn-outline-light navbar-btn ml-md-2">Contact us</a> </div>
    </div>
</nav>
<nav class="navbar navbar-expand-md pi-draggable navbar-dark bg-primary">
