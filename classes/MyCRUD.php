			...
			if (ceil($total_pages / $num_results_on_page) > 0) {
				...
				<nav aria-label="page navigation mx-auto">
					<ul class="pagination justify-content-center">
						<?php if ($page > 1) { ?>
							<li class="page-item prev"><a href="<?php echo $url; ?>&page=<?php echo $page - 1 ?>">Previous</a></li>
						<?php } ?>
						<?php if ($page > 3) { ?>
						...
						<?php } ?>
						<?php if ($page - 2 > 0) { ?>
							<li class="page-item page"><a href="<?php echo $url; ?>&page=<?php echo $page - 2 ?>"><?php echo $page - 2 ?></a>
							</li>
						<?php } ?>
						<?php if ($page - 1 > 0) { ?>
							<li class="page-item page"><a href="<?php echo $url; ?>&page=<?php echo $page - 1 ?>"><?php echo $page - 1 ?></a>
							</li>
						<?php } ?>
						<li class="page-item currentpage"><a href="<?php echo $url; ?>&page=<?php echo $page ?>"><?php echo $page ?></a>
						</li>
						...
						<?php if ($page < ceil($total_pages / $num_results_on_page) - 2) { ?>
							...
							<li class="page-item end"><a
									href="<?php echo $url; ?>&page=<?php echo ceil($total_pages / $num_results_on_page) ?>"><?php echo ceil($total_pages / $num_results_on_page) ?></a>
							</li>
						<?php } ?>
						<?php if ($page < ceil($total_pages / $num_results_on_page)) { ?>
							<li class="page-item next"><a href="<?php echo $url; ?>&page=<?php echo $page + 1 ?>">Next </a></li>
						<?php } ?>
					</ul>
				</nav>
				<?php
...
\$insert->bind_param('" . $ctypes . "'," . $bnames . " );
\$insert->execute();
\$insert->close();" . "\n";
		$content .= "}" . "\n";
		$content .= "?> \n";
				...
				<nav aria-label="Page navigation">
					<ul class="pagination justify-content-center mx-auto">
						...
						<?php if ($page < ceil($total_pages / $num_results_on_page) - 2) { ?>
							<li class="dots">...</li>
							<li class="end"><a
									href="search.php?page=<?php echo ceil($total_pages / $num_results_on_page) ?>"><?php echo ceil($total_pages / $num_results_on_page) ?></a>
							</li>
						<?php } ?>
						<?php if ($page < ceil($total_pages / $num_results_on_page)) { ?>
