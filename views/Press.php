            ...
            ?> 
                    ...
                    <div class='w-100'> 
                        ...
                        <form action='' method='POST'>  
                            ...
                            <div class='col-md-6'><label class="form-label">Sub Título:</label><input type="text" class="form-control" name='subtitle' id='subtitle'/></div> 
                            ...
                            <div class='col-md-6'><label class="form-label">Fecha de publicacion:</label><input type="text" class="form-control" name='printing_date' id='printing_date'/></div> 
                            <div class='col-md-6'><label class="form-label">Tipo de publicacion:</label>
                        ...
                        if (isset($_GET['idPr']) && !empty($_GET['idPr'])) {
                            ...
                            <form action='' method='POST'> 
                                <div class='col-md-6'>
                                    ...
                                    <div class='w-100'><label class="form-label">Sub Título:</label><input type="text" class="form-control" name='subtitle' id='subtitle' value='<?php echo $row['subtitle']; ?>' /></div> 
                                </div> 
                                <div class='col-md-6'><label class="form-label">Imagen:</label>
                                    <script src="<?php echo SYST; ?>js/jquery.popupwindow.js" type="text/javascript"></script> 
                                    <script type="text/javascript">
                                ...
                                <div class='w-100'><label class="form-label">Descripción:</label><textarea class="form-control" name='description' id='description'><?php echo $row['description']; ?></textarea></div> 
                                <script>
                                ...
                                <div class='col-md-6'><label class="form-label">Fecha de publicacion:</label><input type="text" class="form-control" name='printing_date' id='printing_date' value='<?php echo $row['printing_date']; ?>' /></div> 
                                <div class='col-md-6'><label class="form-label">Tipo de publicacion:</label>
                                    <select class="form-select" name='type_press' id='type_press'>
                                        <?php
                                        $acti = array("Entrevista", "Articulo", "Catalogo");
                                ...
                                <div class='w-100'><input class="btn btn-secondary" type='submit' value='Editar Publicacion' /><input type='hidden' value='1' name='submitted' /></div> 
