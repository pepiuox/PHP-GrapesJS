...
if (isset($_GET['w']) && !empty($_GET['w'])) {
        ...
        if ($w === 'list') {
            ...
            <div class='w-100'>
                ...
                <div class='w-100'> 
                    <div class='col-md-6'><label class="form-label">Galeria:</label><?php echo $row['gallery']; ?></div> 
                    <div class='col-md-6'><label class="form-label">Título:</label><?php echo $row['name']; ?></div> 
                    <div class='col-md-6'><label class="form-label">Imagen:</label><img src="<?php echo $row['image']; ?>" width="220" /></div> 
                    <div class='col-md-6'><label class="form-label">Descripción:</label><?php echo $row['description']; ?></div> 
                    <div class='col-md-6'><label class="form-label">Origen:</label>
                        <?php
                        if ($row['source'] == 0) {
                            echo 'youtube';
                        } elseif ($row['source'] == 1) {
                    ...
                    <div class='col-md-6'><label class="form-label">Id Video:</label><?php echo $row['idlink']; ?></div>                 
                </div> 
            </div>
