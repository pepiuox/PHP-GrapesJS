            ...
            ?> 
                    ...
                    <form action='' method='POST'> 
                        ...
                        <div class='col-md-6'>
                            ...
                            <div class='w-100'><label class="form-label">Título:</label><input type="text" class="form-control" name='title' id='title'/></div>                 
                            <div class='w-100'><label class="form-label">Descripción EN:</label><textarea class="form-control" name='description_en' id='description_en'></textarea></div> 
                            <div class='w-100'><label class="form-label">Descripción ES:</label><textarea class="form-control" name='description_es' id='description_es'></textarea></div> 
                            ...
                            <div class='w-100'><label class="form-label">Id Video:</label><input type="text" class="form-control" name='idlink' id='idlink'/></div> 
                            <div class='w-100'>
                        ...
                        <div class='w-100'><input class="btn btn-primary" type='submit' value='Agregar Video' /><input type='hidden' value='1' name='submitted' /></div> 
                    ...
                    if (isset($_GET['idVd']) && !empty($_GET['idVd'])) {
                        ...
                        <form action='' method='POST'> 
                            ...
                            <div class='col-md-6'>
                                ...
                                <div class='w-100'><label class="form-label">Título:</label><input type="text" class="form-control" name='title' id='title' value='<?php echo $row['title']; ?>' /></div>                    
                                <div class='w-100'><label class="form-label">Descripción EN:</label><textarea class="form-control" name='description_en' id='description_en'><?php echo $row['description_en']; ?></textarea></div> 
                                <div class='w-100'><label class="form-label">Descripción ES:</label><textarea class="form-control" name='description_es' id='description_es'><?php echo $row['description_es']; ?></textarea></div> 
                                <div class='w-100'><label class="form-label">Origen:</label>
                                    <select class="form-select" name='source' id='source'>
                                        <?php
                                        $vacti = array("youtube", "vimeo", "daylimotion");
                                ...
                                <div class='w-100'><label class="form-label">Id Video:</label><input type="text" class="form-control" name='idlink' id='idlink' value='<?php echo $row['idlink']; ?>' /></div> 
                                <div class='w-100'>
                                    <label class="form-label">Activo:</label>
                                    <select class="form-select" name='active' id='active'>
                                        <?php
                            ...
                            <div class='w-100'><input class='button' type='submit' value='Editar Video' /><input type='hidden' value='1' name='submitted' /></div> 
...
<div class='w-100'> 
                ...
                <div class='w-100'> 
                    <div class=''><label class="form-label">Paginá:</label><?php echo $row['pageId']; ?></div> 
                    <div class=''><label class="form-label">Título:</label><?php echo $row['title']; ?></div> 
                    <div class=''><label class="form-label">Imagen:</label><?php echo $row['image']; ?></div> 
                    <div class=''><label class="form-label">Descripción:</label><?php echo $row['description']; ?></div> 
                    <div class=''><label class="form-label">Origen:</label><?php echo $row['source']; ?></div> 
                    <div class=''><label class="form-label">Id Video:</label><?php echo $row['idlink']; ?></div> 
                    <div class=''><label class="form-label">Activo:</label><?php echo $row['active']; ?></div> 
                </div> 
            </div>
<?php
        } elseif ($w === 'delete') {
