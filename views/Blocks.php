            ...
            ?> 
                    ...
                    <div class='w-100'> 
                        ...
                        <form action='' method='POST'> 
                            <div class="w-100"><label class="form-label">Tipo de Bloque:</label>
                                <?php
                            ...
                            <div class="w-100"><input class="btn btn-primary" type='submit' value='Agregar Bloque' /><input type='hidden' value='1' name='submitted' /></div> 
            ...
            ?> 
                    ...
                    <div class='w-100'> 
                        ...
                        if (isset($_GET['idB'])) {
                            ...
                            $row = $database->query("SELECT * FROM `blocks` WHERE `idB` = '$idB' ")->fetch_assoc();
                            ?>
                            <p>
                            ...
                            <form action='' method='POST'> 
                                <div class="w-100"><label class="form-label">Bloque:</label>
                                ...
                                <div class="w-100"><input class="btn btn-primary" type='submit' value='Editar Bloque' /><input type='hidden' value='1' name='submitted' /></div> 
