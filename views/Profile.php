<div class="w-100"> 
                ...
                <form action='' method='POST'>                     
                    <div class='col-md-6'>
                        <label class="form-label">Nombres:</label><input type="text" class="form-control" name='first_name' id='first_name' value='<?php echo $row['first_name']; ?>' />
                        <label class="form-label">Apellidos:</label><input type="text" class="form-control" name='last_name' id='last_name' value='<?php echo $row['last_name']; ?>' />
                        <label class="form-label">Edad:</label><input type="text" class="form-control" name='age' id='age' value='<?php echo $row['age']; ?>' />
...
foreach($acti as $key => $val ) {
                    ...
                    <div class='w-100'><input class="btn btn-secondary" type='submit' value='Editar Perfil' /><input type='hidden' value='1' name='submitted' /></div> 
