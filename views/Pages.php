                ...
                if ($w === 'list') {
                    ...
                    <div class='w-100'>  
                        ...
                        while ($row = $result->fetch_array()) {
                            ...
                            $rest = $database->query("SELECT * FROM `page` WHERE `id` = '$parnt' ");
                            if ($rest->num_rows > 0) {
                    ...
                    <div class='w-100'> 
                        ...
                        if (isset($_POST['submitted'])) {
                            ...
                            if ($_POST['startpage'] === 1) {
                                //$qr = mysqli_fetch_array($database->query("SELECT * FROM page WHERE startpage = '1' "));
...
<div class='row'>
                                ...
                                <div class='w-100'><input class="btn btn-primary" type='submit' value='Agregar Página' /><input type='hidden' value='1' name='submitted' /></div> 
                            </div>
                        </form> 
                    </div>
...
<div class='w-100'> 
            ...
            if (isset($_GET['id']) && !empty($_GET['id'])) {
                $id = (int) $_GET['id'];
                $row = mysqli_fetch_array($database->query("SELECT * FROM `page` WHERE `id` = '$id' "));
                $langr = $row["languague"];
                ...
                <form action='' method='POST'> 
                    ...
                    <div class='col-md-6'>
                        ...
                        <div class='w-100'><label class="form-label">Tipo de menu:</label>
                            <?php
                            $sqpm = "SELECT * FROM type_menu";
                            $querypm = $database->query($sqpm);
                            ?> 
