...
INSERT INTO `active_guests` (`ip`, `timestamp`) VALUES
	('127.0.0.1', '2024-04-05 12:28:01'),
	('::1', '2024-04-05 22:08:49'),
	('127.0.0.1', '2025-01-08 00:56:21');
...
CREATE TABLE IF NOT EXISTS `auth_tokens` (
  ...
  `auth_type` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `carousel_picture` (
  `carousel_picture_id` int NOT NULL AUTO_INCREMENT,
  `carousel_widget_id` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `carousel_widget` (
  `carousel_widget_id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `active` int DEFAULT NULL,
  `custom_temp_active` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `forgot_pass` (
  ...
  `password_key` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `forgot_pin` (
  ...
  `username` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `email` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `pin_key` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `create` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `expire` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE IF NOT EXISTS `form_main` (
  `form_main_id` int NOT NULL AUTO_INCREMENT,
  ...
  `send_to_visitor` int DEFAULT NULL,
  `email_field_id` int DEFAULT NULL,
  `visitor_subject` varchar(255) DEFAULT NULL,
  `visitor_body` text,
  `active` int DEFAULT NULL,
  `captcha` int DEFAULT NULL,
  `save_to_db` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `gallery_config` (
  `gallery_config_id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gallery_db` (
  `gallery_db_id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gateways` (
  ...
  `exchange_type` int DEFAULT NULL,
  `include_fee` int DEFAULT NULL,
  `extra_fee` varchar(255) DEFAULT NULL,
  `fee` varchar(255) DEFAULT NULL,
  `allow_send` int DEFAULT NULL,
  `allow_receive` int DEFAULT NULL,
  `default_send` int DEFAULT NULL,
  `default_receive` int DEFAULT NULL,
  `allow_payouts` int DEFAULT NULL,
  ...
  `external_gateway` int NOT NULL DEFAULT '0',
  `external_icon` text
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE IF NOT EXISTS `ip` (
  ...
  `address` char(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE IF NOT EXISTS `link_statistic` (
  `link_statistic_id` int NOT NULL AUTO_INCREMENT,
  `link` varchar(255) DEFAULT NULL,
  `ip_address` varchar(255) DEFAULT NULL,
  `timestamp_create` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `link_stat_mgt` (
  `link_stat_mgt_id` int NOT NULL AUTO_INCREMENT,
  `url` varchar(255) DEFAULT NULL,
  `timestamp_create` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Dumping structure for table grapesjs.pages
...
-- Dumping data for table grapesjs.pageviews: ~0 rows (approximately)
INSERT INTO `pageviews` (`id`, `page`, `ip`, `date_view`) VALUES
	(1, 'Home', '127.0.0.1', '2025-01-08 00:57:46');
...
CREATE TABLE IF NOT EXISTS `site_configuration` (
  ...
  `SUPERADMIN_LEVEL` tinyint DEFAULT NULL,
...
INSERT INTO `site_configuration` (`ID_Site`, `DOMAIN_SITE`, `SITE_NAME`, `SITE_BRAND_IMG`, `SITE_PATH`, `SITE_DESCRIPTION`, `SITE_KEYWORDS`, `SITE_CLASSIFICATION`, `SITE_EMAIL`, `SITE_IMAGE`, `SITE_ADMIN`, `SITE_CONTROL`, `SITE_CONFIG`, `SITE_LANGUAGE_1`, `SITE_LANGUAGE_2`, `FOLDER_IMAGES`, `SITE_CREATOR`, `SITE_EDITOR`, `SITE_BUILDER`, `SITE_LIST`, `NAME_CONTACT`, `PHONE_CONTACT`, `EMAIL_CONTACT`, `ADDRESS`, `TWITTER`, `FACEBOOKID`, `SKYPE`, `TELEGRAM`, `WHATSAPP`, `MAILSERVER`, `PORTSERVER`, `USEREMAIL`, `PASSMAIL`, `SUPERADMIN_NAME`, `SUPERADMIN_LEVEL`, `ADMIN_NAME`, `ADMIN_LEVEL`, `SECURE_HASH`, `SECURE_TOKEN`, `CREATE`, `UPDATED`) VALUES
	(1, 'http://www.pepiuox.net', 'PEPIUOX', 'icon-pepiuox.png', 'http://localhost:180/', 'Your description for your domains', 'Your keywords for your domains', 'Your classification for your domains', 'info@phpgrapesjs.com', 'dashboard', 'dashboard', 'users', 'siteconf', 'English', 'Spanish', 'uploads', 'admin', 'admin, editor', 'builder', 'list', 'Jose Mantilla', '0051999063645', 'contact@pepiuox.net', 'Lima - Peru', '@pepiuox', 'pepiuox30675', 'pepiuox', 'pepiuox', '+51 999063645', 'smtp.hostinger.com', '461', 'contact@pepiuox.net', 'truelove', 'Super Admin', 9, 'Admin', 5, 'ab6e7b43c06ecbb7021355026796265875c1da0006c7cdd261079f3cccf769e6', 'ckJ6w2S5Clja}ADs4kskWlorTE3jbk9ZizF6JJAL]Yr9xSHB3}F@No0(akJseo]caxZact$$YhP09&h8GZYsICC&kC44xi2$8@EfRutbmqS]ihvdx68BYYS(1$96R3ZZ', '2022-01-08 18:42:41', '2024-04-05 12:26:39');

-- Dumping structure for table grapesjs.slideshow
DROP TABLE IF EXISTS `slideshow`;
CREATE TABLE IF NOT EXISTS `slideshow` (
  `idSld` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `total_visitors` (`id`, `session`, `time`) VALUES
	(1, 'ZGVXS0Q0UDF6dFVkdFhsUXo0ODlLdz09', '2024-04-14 13:43:01'),
	(2, 'cFpGeHdIcmd1aGZYZ215UTdZYTg2Zz09', '2024-04-06 05:13:20'),
	(3, 'RlJQNExDVHE5WFZoSkQzS1E2bzQwdz09', '2025-01-08 06:57:55');
...
INSERT INTO `uverify` (`iduv`, `username`, `email`, `password`, `mktoken`, `mkkey`, `mkhash`, `mkpin`, `level`, `recovery_phrase`, `activation_code`, `password_key`, `pin_key`, `rp_active`, `is_activated`, `verified`, `banned`, `timestamp`) VALUES
	('1768770676660fa7f610b8e', 'pepiuox', 'contact@labemotion.net', 'K3luRnViVUUveHg0TmJzbUhYZEM2Zz09', '5014056631b21995f7bbec118e290c7b602c3f97', '4382e79d966262a9c98b8029ede60da4a4f9ed67', '7d89d1d7b2e60f2f4d66cf2eb396c9e116990ffc', '665970', 'Super Admin', NULL, NULL, NULL, NULL, 0, 1, 1, 0, '2024-04-14 06:42:56');
...
-- Dumping data for table grapesjs.visitor: ~1 rows (approximately)
INSERT INTO `visitor` (`ip`, `timestamp`, `updated`) VALUES
	('127.0.0.1', '2025-01-08 00:56:21', '2025-01-08 06:57:55');
